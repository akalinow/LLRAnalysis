...
#include "LLRAnalysis/HHKinFit/interface/DiJetKinFit.h"
...
DiJetKinFitMaster::doFullFit()
{
  ...
  for(std::vector<Int_t>::iterator mh = m_mh.begin(); mh != m_mh.end(); mh++){
    ...
    DiJetKinFit advancedfitter(&eventrecord_rec);
...
DiJetKinFitMaster::DiJetKinFitMaster(TLorentzVector* bjet1, TLorentzVector* bjet2):
...
Double_t
DiJetKinFitMaster::getBestChi2FullFit()
{
  return m_bestChi2FullFit;
}

std::map< std::pair< Int_t, Int_t >, Double_t >
DiJetKinFitMaster::getChi2FullFit(){
  return m_fullFitResultChi2;
}

std::map< std::pair< Int_t, Int_t >, Double_t >
DiJetKinFitMaster::getFitProbFullFit(){
  return m_fullFitResultFitProb;
}

std::map< std::pair< Int_t, Int_t >, Double_t >
DiJetKinFitMaster::getPullB1FullFit(){
  return m_fullFitPullB1;
}

std::map< std::pair< Int_t, Int_t >, Double_t >
DiJetKinFitMaster::getPullB2FullFit(){
  return m_fullFitPullB2;
}

std::map< std::pair< Int_t, Int_t >, Int_t >
DiJetKinFitMaster::getConvergenceFullFit(){
  return m_fullFitConvergence;
}

std::pair<Int_t, Int_t>
DiJetKinFitMaster::getBestHypoFullFit()
{
  return m_bestHypoFullFit;
}

void
DiJetKinFitMaster::addMhHypothesis(Double_t m1, Double_t m2, Double_t m3, Double_t m4, Double_t m5, Double_t m6, Double_t m7, Double_t m8, Double_t m9, Double_t m10)
{
...
void
DiJetKinFitMaster::addMhHypothesis(std::vector<Int_t> v)
{
  m_mh = v;
}

double
DiJetKinFitMaster::GetBjetResolution(double eta, double et){
  double det=0;
  double de=10;
