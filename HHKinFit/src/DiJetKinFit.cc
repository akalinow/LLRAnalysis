...
DiJetKinFit::DiJetKinFit(HHEventRecord* recrecord)
...
DiJetKinFit::Fit()
{
std::cout << "<DiJetKinFit::Fit>:" << std::endl;
  //  ----------  for PSfit -----
  const Int_t np = 1;
  Double_t a[np];
  Double_t astart[np];
...
void
DiJetKinFit::ConstrainE2(Int_t iv4, Int_t iv41, Int_t iv42)
{
...
void
DiJetKinFit::SetPrintLevel(Int_t level){
  m_printlevel = level;
}

void
DiJetKinFit::SetGraphicsLevel(Int_t level){
  m_graphicslevel=level;
}

void
DiJetKinFit::SetMaxLoops(Int_t loops){
  m_maxloops = loops;
}
...
Double_t
DiJetKinFit::GetChi2_b1()
{
  return m_chi2_b1;
}

Double_t
DiJetKinFit::GetChi2_b2()
{
  return m_chi2_b2;
}

Double_t
DiJetKinFit::GetConvergence()
{
  return m_convergence;
}

HHEventRecord*
DiJetKinFit::GetFitrecord(){
  return m_fitrecord;
}

void
DiJetKinFit::SetLogLevel(Int_t level)
{
  m_logLevel = level;
}

double
DiJetKinFit::GetPullE(Int_t iv4){
