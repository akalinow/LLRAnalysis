...
process.FWLiteTauTauAnalyzer = cms.PSet(
    ...
    bJetLooseToTightWeight = cms.PSet(
        ...
        fitFunctionShapeName_bJet1 = cms.string("bJetLooseToTightWeight/btag/$particleEtaBin/fitFunctionShape_bJet1PtS_SSvrelaxed1_vrelaxed2_TightBtag_div_SSvrelaxed1_vrelaxed2_LooseBtag"),
        fitFunctionShapePower_bJet1 = cms.double(1.0),
        applyFitFunction_or_graph_bJet1 = cms.string("fitFunction")
    ),
    ...
    jetToTauFakeRateLooseToTightWeight = cms.PSet(
        ...
        fitFunctionShapeName_tau1_central = cms.string("jetToTauFakeRate/inclusive/$particleEtaBin/fitFunctionShape_tau1PtS_SSisoLooseBtag_div_SSrelaxedLooseBtag"),
