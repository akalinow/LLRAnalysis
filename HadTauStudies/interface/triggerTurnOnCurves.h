...
double eff2012IsoParkedTau_Arun_cutMedium(double, double);
double effDrop2012IsoParkedTau_Arun_mvaTight(double, double);
double eff2012IsoParkedTau_Arun_mvaTight(double, double);
double effDrop2012IsoParkedTau_Arun_mvaVTight(double, double);
double eff2012IsoParkedTau_Arun_mvaVTight(double, double);
double eff2012IsoParkedTauMC_Arun_cutMedium(double, double);
