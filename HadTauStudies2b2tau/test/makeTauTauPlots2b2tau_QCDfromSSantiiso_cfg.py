...
process.makeTauTauPlots2b2tau = cms.PSet(
    ...
    signal1 = cms.PSet(
        ...
        # CV: scale non-resonant signal to 500x Standard Model cross-section:
    ...
    distributions = cms.VPSet(
        ...
        cms.PSet(
            histogramName = cms.string("tau1GenMatch"),
            xAxisTitle = cms.string("#tau_{1} gen. match"),
        ...
        cms.PSet(
            histogramName = cms.string("tau2GenMatch"),
            xAxisTitle = cms.string("#tau_{2} gen. match"),
            yAxisTitle = cms.string("N")
        ),
        cms.PSet(
            histogramName = cms.string("deltaRtt"),
            xAxisTitle = cms.string("#Delta R (#tau_{1},#tau_{2})"),
            yAxisTitle = cms.string("dN/d#Delta R (#tau_{1},#tau_{2})")
        ),
        cms.PSet(
        ...
        cms.PSet(
            ...
            keepBlinded = cms.vstring("70:150")
        ),
        cms.PSet(
            histogramName = cms.string("HttPtL"),
            xAxisTitle = cms.string("P_{T}^{#tau#tau} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{#tau#tau} [1/GeV]")
        ),        
        cms.PSet(
        ...
        cms.PSet(
            ...
            xAxisTitle = cms.string("m_{bb}^{MVA} [GeV]"),
            yAxisTitle = cms.string("dN/dm_{bb}^{MVA} [1/GeV]"),
            keepBlinded = cms.vstring("100:150")
        ),
        cms.PSet(
            histogramName = cms.string("HbbPtL"),
            xAxisTitle = cms.string("P_{T}^{bb} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{bb} [1/GeV]")
        ),
        cms.PSet(
            histogramName = cms.string("HbbRegPtL"),
            xAxisTitle = cms.string("P_{T}^{bb} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{bb} [1/GeV]")
        ),
        cms.PSet(
        ...
        cms.PSet(
            ...
            xAxisTitle = cms.string("P_{#zeta} - P_{#zeta}^{vis} [GeV]"),
            yAxisTitle = cms.string("dN/d(P_{#zeta} - P_{#zeta}^{vis}) [1/GeV]")
        ),
        cms.PSet(
        ...
        cms.PSet(
            ...
            xAxisTitle = cms.string("#Chi_{2b}^{2}"),
            yAxisTitle = cms.string("dN/d#Chi_{2b}^{2}")
        ),        
        cms.PSet(
        ...
        cms.PSet(
            ...
            xAxisTitle = cms.string("#Chi_{2b2#tau}^{2}"),
            yAxisTitle = cms.string("dN/d#Chi_{2b2#tau}^{2}")
        ), 
        cms.PSet(
        ...
        cms.PSet(
            histogramName = cms.string("HHPtS"),
            xAxisTitle = cms.string("P_{T}^{2b2#tau} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{2b2#tau} [1/GeV]")
        ),
        cms.PSet(
            histogramName = cms.string("HHbRegPtS"),
            xAxisTitle = cms.string("P_{T}^{2b2#tau} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{2b2#tau} [1/GeV]")
        ),
        cms.PSet(
        ...
        cms.PSet(
            ...
            xAxisTitle = cms.string("P_{T}^{b-jet_{1}} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{b-jet_{1}} [1/GeV]")
        ),
        cms.PSet(
            histogramName = cms.string("bJet1Eta"),
            xAxisTitle = cms.string("#eta_{b-jet_{1}}"),
            yAxisTitle = cms.string("dN/d#eta_{b-jet_{1}}")
        ),
        cms.PSet(
            histogramName = cms.string("bJet1Phi"),
            xAxisTitle = cms.string("#phi_{b-jet_{1}}"),
            yAxisTitle = cms.string("dN/d#phi_{b-jet_{1}}")
        ),
        cms.PSet(
            histogramName = cms.string("bJet2PtS"),
            xAxisTitle = cms.string("P_{T}^{b-jet_{2}} [GeV]"),
            yAxisTitle = cms.string("dN/dP_{T}^{b-jet_{2}} [1/GeV]")
        ),
        cms.PSet(
            histogramName = cms.string("bJet2Eta"),
            xAxisTitle = cms.string("#eta_{b-jet_{2}}"),
            yAxisTitle = cms.string("dN/d#eta_{b-jet_{2}}")
        ),
        cms.PSet(
            histogramName = cms.string("bJet2Phi"),
            xAxisTitle = cms.string("#phi_{b-jet_{2}}"),
            yAxisTitle = cms.string("dN/d#phi_{b-jet_{2}}")
        ),
        cms.PSet(
            histogramName = cms.string("deltaRbb"),
            xAxisTitle = cms.string("#Delta R (b-jet_{1},b-jet_{2})"),
            yAxisTitle = cms.string("dN/d#Delta R (b-jet_{1},b-jet_{2})")
        ),
        cms.PSet(
            histogramName = cms.string("numBJetsLoose"),
            xAxisTitle = cms.string("N_{b-jet} (Loose)"),
            yAxisTitle = cms.string("dN/dN_{b-jet}")
        ),
        cms.PSet(
            histogramName = cms.string("numBJetsMedium"),
            xAxisTitle = cms.string("N_{b-jet} (Medium)"),
            yAxisTitle = cms.string("dN/dN_{b-jet}")
        ),
        cms.PSet(
