...
void produce(   
  ...
  while (in.good())
	...
	else if(line.find( "CMS_htt_eleTau_SM2_ttbarNorm" )!=string::npos){
	...
	else if(line.find( "CMS_htt_eleTau_SM2_DiBosonNorm" )!=string::npos){
	...
	else if(line.find( "CMS_htt_eleTau_SM2_QCDSyst")!=string::npos){
	  line.replace( line.find("XXX") , 3 , string(Form("%.2f",1.0+((TH1F*)fin->Get("hParameters"))->GetBinContent(7)))  );
	  out << line << endl;
	}
	else if(line.find( "CMS_htt_eleTau_SM2_WNorm")!=string::npos){
	...
	else if(line.find( "CMS_htt_eleTau_SM0_WNorm")!=string::npos){
	...
	else if(line.find( "CMS_htt_eleTau_SM2_ZJetFakeTauNorm" )!=string::npos){
	...
	else if(line.find( "CMS_htt_eleTau_SM2_ZLeptonFakeTauNorm" )!=string::npos){
...
void produceAll(){
  ...
  produce(120,"diTauVisMass", "ElecUp"  , "twoJets");
  produce(120,"diTauVisMass", "ElecDown", "twoJets");
  ...
  produce(120,"diTauVisMass", "ElecUp"  , "oneJet");
  produce(120,"diTauVisMass", "ElecDown", "oneJet");
