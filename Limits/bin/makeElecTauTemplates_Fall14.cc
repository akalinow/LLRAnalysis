...
void produce(   
	     ...
	     bool DOSUSY = false,
	     TString location  = "/data_CMS/cms/davignon/NtuplesProduction_NewTrees_NewTriggers/CMSSW_5_3_11_p6_TauSpinner/src/LLRAnalysis/Limits/bin/results/ElecTau/"
...
{
  if(Displays) cout << "Now doing mass mH=" << mH_ << ", for variable " << variable_ 
...
//   TFile* fTemplOut = new TFile(Form(location+"%s/datacards/eTau%s_%s.root",outputDir.Data(), theory.c_str(),variable_.c_str()),"UPDATE");
  ...
  TFile* fTemplOut = new TFile(Form(location+"%s/datacards/eTau%s_%s_newNames-test4_%s.root",outputDir.Data(), theory.c_str(),variable_.c_str(), WeightNoWeight.Data()),"UPDATE");
...
//       TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%d",mH_));
      ...
      hSMGGFH125_mssmHigh_Up->SetName("ggH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp" );
      hSMGGFH125_mssmHigh_Up->Write("ggH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp");

      TH1F* hSMGGFH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownGGFH125");
      hSMGGFH125_mssmHigh_Down->SetName("ggH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown" );
      hSMGGFH125_mssmHigh_Down->Write("ggH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown");

      TH1F* hSMVBFH125_mssmHigh_Up = (TH1F*)fin->Get("hSMEffTUpVBFH125");
      hSMVBFH125_mssmHigh_Up->SetName("qqH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp" );
      hSMVBFH125_mssmHigh_Up->Write("qqH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp");

      TH1F* hSMVBFH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownVBFH125");
      hSMVBFH125_mssmHigh_Down->SetName("qqH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown" );
      hSMVBFH125_mssmHigh_Down->Write("qqH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown");

      TH1F* hSMVH125_mssmHigh_Up = (TH1F*)fin->Get("hSMEffTUpVH125");
      hSMVH125_mssmHigh_Up->SetName("VH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp" );
      hSMVH125_mssmHigh_Up->Write("VH_SM125_CMS_eff_t_mssmHigh_etau_8TeVUp");

      TH1F* hSMVH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownVH125");
      hSMVH125_mssmHigh_Down->SetName("VH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown" );
      hSMVH125_mssmHigh_Down->Write("VH_SM125_CMS_eff_t_mssmHigh_etau_8TeVDown");
...
//       //SM signals shifted Up/Down by T-ES
//       TH1F* hSMGGFH125 = (TH1F*)fin->Get("hGGFH125");
...
//       TH1F* hDataEmb = ((TH1F*)fin->Get("hDataEmb"));
      ...
      TH1F* hDataEmb_fb = ((TH1F*)fin->Get(nameZtt+"_fb"));
      //remove zero bins + setting right error
...
//         hQCD->SetName(Form("QCD%s"    ,suffix.c_str()));
	...
	TString QCDCorrUpName = "QCD_CMS_htt_QCDfrShape_etau" ;
// 	QCDCorrUpName = QCDCorrUpName+"_"+binNameSpace;
	...
	TString QCDCorrDownName = "QCD_CMS_htt_QCDfrShape_etau" ;
// 	QCDCorrDownName = QCDCorrDownName+"_"+binNameSpace;
	...
	TString QCDCorrUpName_fb = "QCD_CMS_htt_QCDfrShape_etau" ;
// 	QCDCorrUpName_fb = QCDCorrUpName_fb+"_"+binNameSpace;
	...
	TString QCDCorrDownName_fb = "QCD_CMS_htt_QCDfrShape_etau" ;
...
//   variables.push_back("diTauNSVfitMass");//was commented here
...
void produceAll(){ 
  ...
  TString simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_ptL_hi_060215/";
//   TString simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_ptL_md_060215/";
//   TString simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_060215/";
//   TString simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_261114/";
...
//   variables.push_back("MtLeg1MVA");
  ...
  for(UInt_t i = 0 ; i < variables.size() ; ++i)
	...
	{// 
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_tauPolarOn_110215";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_tauPolarOn_110215/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_tauPolarOn_110215/datacards/eTau*_NoPtWeight.root") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_230115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_230115/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_230115/datacards/eTau*_NoPtWeight.root") ;

	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215";
	  TString OutFileName = "";
	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215/datacards/eTau*_PtWeight.root") ;
	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215/datacards/eTau*_NoPtWeight.root") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_250115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_250115/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_250115/datacards/eTau*_NoPtWeight.root") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115/datacards/eTau*_NoPtWeight.root") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_031214";
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115";
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_200115";
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115";
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_140115";
// 	  TString local_simple_folder = "Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_281214";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115/datacards/eTau*_PtWeight.root") ;
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_200115/datacards/eTau*_PtWeight.root") ;
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115/datacards/eTau*_NoPtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_200115/datacards/eTau*_NoPtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115/datacards/eTau*_NoPtWeight.root") ;
// 	  if(HiggsPtReweighting) OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_140115/datacards/eTau*_PtWeight.root") ;
// 	  else OutFileName = Form("results/ElecTau/Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_140115/datacards/eTau*_NoPtWeight.root") ;
