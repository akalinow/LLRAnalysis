...
def analyze(mH,category,analysis,variable,xtitle,unity,outputDir,nBins,xMin,xMax,magnify,hltEff,logy,maxY,RUN):
    ...
    ##
    f.write('analyze'+stream+'_Spring13 '+str(mH)+' '+category+' '+variable+' '+xtitle+' '+unity +' '+str(nBins)+' '+str(xMin)+' '+str(xMax)+' '+str(magnify)+' '+str(hltEff)+' '+str(logy)+' '+str(maxY)+' '+outputDir+' '+RUN+' '+analysis+' > '+fileLog+'\n')
    f.close()
...
## analyze(125,"inclusive","TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,35,0,350,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfLow" ,"TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfHigh","TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostLow" ,"TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostHigh","TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"vbf"      ,"TauUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");

## analyze(125,"inclusive","TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,35,0,350,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfLow" ,"TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfHigh","TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostLow" ,"TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostHigh","TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"vbf"      ,"TauDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");

## analyze(125,"inclusive","JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,35,0,350,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfLow" ,"JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfHigh","JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostLow" ,"JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostHigh","JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"vbf"      ,"JetUp" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");

## analyze(125,"inclusive","JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,35,0,350,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfLow" ,"JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"novbfHigh","JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostLow" ,"JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"boostHigh","JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"vbf"      ,"JetDown" ,"diTauNSVfitMass" ,"'SVfit mass'","GeV",outputDir,-1,0,100,5.0,1.0,0,1.2,"ABCD");
...
## analyze(125,"inclusiveQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"inclusiveQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"inclusiveQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

## analyze(125,"novbfHighQCDEn"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"novbfHighQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"novbfHighQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"novbfHighQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

## analyze(125,"novbfLowQCDEn"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"novbfLowQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"novbfLowQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"novbfLowQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

## analyze(125,"boostHighQCDEn"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"boostHighQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"boostHighQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"boostHighQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

## analyze(125,"boostLowQCDEn"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"boostLowQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"boostLowQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"boostLowQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

## analyze(125,"vbfQCDEn"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"vbfQCDEn"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 
## analyze(125,"vbfQCDEnSS"      ,""   ,"diTauNSVfitMass" ,"'SVfit mass'","GeV"            ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABC","ABCD");
## analyze(125,"vbfQCDEnSS"      ,""   ,"diTauVisMass","'Visible mass'","GeV"              ,outputDir,20,0,200,5.0,1.0,0,1.2,"ABC","ABCD"); 

##Decay modes
## ## #analyze(125,"inclusiveDM0BLHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM0BLHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong0Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0BLHigh",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 BLHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM0BLHigh",""   ,"ptL2"         ,"'#tau p_{T} 1Prong0Pi0 BLHigh'" ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1BLHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1BLHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong1Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1BLHigh",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 BLHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1BLHigh",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 BLHigh'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2BLHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2BLHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 3Prongs'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2BLHigh",""   ,"diTauVisMass" ,"'visible mass 3Prongs BLHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2BLHigh",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs BLHigh'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
 
## ## #analyze(125,"inclusiveDM0ECHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM0ECHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong0Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0ECHigh",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 ECHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM0ECHigh",""   ,"ptL2"         ,"'#tau p_{T} 1Prong0Pi0 ECHigh'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1ECHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1ECHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong1Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1ECHigh",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 ECHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1ECHigh",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 ECHigh'" ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2ECHigh",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2ECHigh",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 3Prongs'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2ECHigh",""   ,"diTauVisMass" ,"'visible mass 3Prongs ECHigh'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2ECHigh",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs ECHigh'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");

## ## #analyze(125,"inclusiveDM0BLLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM0BLLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong0Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0BLLow",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 BLLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM0BLLow",""   ,"ptL2"         ,"'#tau p_{T} 1Prong0Pi0 BLLow'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1BLLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1BLLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong1Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1BLLow",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 BLLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1BLLow",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 BLLow'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2BLLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2BLLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 3Prongs'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2BLLow",""   ,"diTauVisMass" ,"'visible mass 3Prongs BLLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2BLLow",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs BLLow'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");

## ## #analyze(125,"inclusiveDM0ECLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM0ECLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong0Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0ECLow",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 ECLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM0ECLow",""   ,"ptL2"         ,"'#tau p_{T}  1Prong0Pi0 ECLow'" ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1ECLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM1ECLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 1Prong1Pi0'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1ECLow",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 ECLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1ECLow",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 ECLow'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2ECLow",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## #analyze(125,"inclusiveDM2ECLow",""   ,"visibleTauMass" ,"'visible \#tau_{h} mass 3Prongs'","GeV"  ,outputDir,20,0,2,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2ECLow",""   ,"diTauVisMass" ,"'visible mass 3Prongs ECLow'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2ECLow",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs ECLow'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");

## analyze(125,"inclusiveDM0BLLow",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 BL Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM0BLHigh",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 BL High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM0BL",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 BL'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM0BL",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0 BL'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0BL",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 BL'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0BL",""   ,"ptL2"         ,"'#tau p_{T}  1Prong0Pi0 BL'" ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1BLLow",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 BL Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM1BLHigh",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 BL High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM1BL",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 BL'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM1BL",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0 BL'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1BL",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 BL'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1BL",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 BL'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2BLLow",""   ,"etaL2"           ,"'#tau #eta 3Prongs BL Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM2BLHigh",""   ,"etaL2"           ,"'#tau #eta 3Prongs BL High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM2BL",""   ,"etaL2"           ,"'#tau #eta 3Prongs BL'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM2BL",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs BL'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2BL",""   ,"diTauVisMass" ,"'visible mass 3Prongs BL'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2BL",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs BL'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");

## analyze(125,"inclusiveDM0ECLow",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 EC Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM0ECHigh",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 EC High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM0EC",""   ,"etaL2"           ,"'#tau #eta 1Prong0Pi0 EC'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM0EC",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong0Pi0 EC'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0EC",""   ,"diTauVisMass" ,"'visible mass 1Prong0Pi0 EC'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM0EC",""   ,"ptL2"         ,"'#tau p_{T}  1Prong0Pi0 EC'" ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM1ECLow",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 EC Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM1ECHigh",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 EC High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM1EC",""   ,"etaL2"           ,"'#tau #eta 1Prong1Pi0 EC'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM1EC",""   ,"diTauNSVfitMass" ,"'SVfit mass 1Prong1Pi0 EC'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1EC",""   ,"diTauVisMass" ,"'visible mass 1Prong1Pi0 EC'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM1EC",""   ,"ptL2"         ,"'#tau p_{T} 1Prong1Pi0 EC'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");
## analyze(125,"inclusiveDM2ECLow",""   ,"etaL2"           ,"'#tau #eta 3Prongs EC Low'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM2ECHigh",""   ,"etaL2"           ,"'#tau #eta 3Prongs EC High'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## analyze(125,"inclusiveDM2EC",""   ,"etaL2"           ,"'#tau #eta 3Prongs EC'","units"                       ,outputDir,36,-2.4, 2.4,5.0,1.0,0,2.,"ABCD");
## ## analyze(125,"inclusiveDM2EC",""   ,"diTauNSVfitMass" ,"'SVfit mass 3Prongs EC'","GeV"             ,outputDir,36,0,360,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2EC",""   ,"diTauVisMass" ,"'visible mass 3Prongs EC'","GeV"              ,outputDir,8,80,120,5.0,1.0,0,1.2,"ABCD");
## ## analyze(125,"inclusiveDM2EC",""   ,"ptL2"         ,"'#tau p_{T} 3Prongs EC'"  ,"GeV"              ,outputDir,30,0, 120,5.0,1.0,0,1.2,"ABCD");

#Mt plots
## analyze(125,"inclusiveNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"inclusiveSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"novbfLowNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"novbfLowSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"novbfHighNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"novbfHighSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"boostLowNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"boostLowSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"boostHighNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"boostHighSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"vbfHighNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
## analyze(125,"vbfHighSSNoMt"  ,""   ,"MtLeg1MVA","'M_{T}(e#nu)'","GeV",outputDir,40,0,160,5.0,1.0,0,1.2,"ABCD","ABCD");
