		     ...
		     )
{
  ...
  cout<<"SELECTION in chooseSelection :"<< selection_<<endl;
  ...
  if(selection_.find("bTag")!=string::npos && selection_.find("nobTag")==string::npos && selection_.find("inclusive")==string::npos) antiele = "tightestAntiEMVA5WP>1 && tightestAntiECutWP > 0";
  ...
  */
  ...
  if(tree!=0 && h!=0){
	...
	if(     RUN=="ABC")                  weight = "(puWeightHCP*HLTweightTauABC*HLTweightMuABC*SFTau*SFMu_ABC*weightDecayMode)";
	  ...
	  {
	    if(!type.Contains("Emb")) weight = "(puWeight*HLTweightTau*HLTweightMu*SFTau*SFMu*weightDecayMode)";//changed here
	    else weight = "(puWeight*HLTTau*HLTMu*SFTau*SFMu*weightDecayMode)";//changed here
	  }
      }      
...
//       genMass     = "genDiTauMass>50"; // HLTxMu17Mu8
      genMass     = "genDiTauMass>50 && HLTxMu17Mu8>0.5"; // HLTxMu17Mu8 To put back 220115
	...
	else                                 weight = "(HLTTau*HLTMu*SFTau*SFMu*weightDecayMode)";
// 	else                                 weight = "(HLTTau*HLTMu*SFTau*SFMuID*ZmmWeight*weightDecayMode)";
      ...
      if(version_.Contains("DecayModeNoCorr"))
	{
	  if(version_.Contains("Soft")) {
	    ...
	    else                                 weight = "(HLTTau*HLTMu*SFTau*SFMu)";
...
;
    ...
    cout<<"normalization before SF = "<<h->Integral()<<endl;
...
TArrayF createBins(int nBins_ = 80 ,
  ...
  if(MSSM && !variable_.Contains("ptL")) filename = Form(location+"/bins_muTau_%s_%s_mssm.txt",variable_.Data(), selection_.c_str());
  else if(variable_.Contains("ptL")) filename = Form(location+"/bins_muTau_%s_%s_MSSM.txt",variable_.Data(), selection_.c_str());
...
//   float TTxsectionRatio                    = 0.96; // Summer13 value from twiki
  ...
  TH1F* hDataEmb_1Prong0Pi0_TriggerBugUp  = new TH1F( "hDataEmb_1Prong0Pi0_TriggerBugUp","Embedded_TriggerBugUp"          , nBins , bins.GetArray());         hDataEmb_1Prong0Pi0_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_1Prong0Pi0_TriggerBugDown  = new TH1F( "hDataEmb_1Prong0Pi0_TriggerBugDown","Embedded_TriggerBugDown"          , nBins , bins.GetArray());         hDataEmb_1Prong0Pi0_TriggerBugDown->SetFillColor(kOrange-4);
  ...
  TH1F* hDataEmb_1Prong1Pi0_TriggerBugUp  = new TH1F( "hDataEmb_1Prong1Pi0_TriggerBugUp","Embedded_TriggerBugUp"          , nBins , bins.GetArray());         hDataEmb_1Prong1Pi0_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_1Prong1Pi0_TriggerBugDown  = new TH1F( "hDataEmb_1Prong1Pi0_TriggerBugDown","Embedded_TriggerBugDown"          , nBins , bins.GetArray());         hDataEmb_1Prong1Pi0_TriggerBugDown->SetFillColor(kOrange-4);

  TH1F* hDataEmb_3Prong  = new TH1F( "hDataEmb_3Prong","Embedded"          , nBins , bins.GetArray());         hDataEmb_3Prong->SetFillColor(kOrange-4);
  TH1F* hDataEmb_3Prong_TriggerBugUp  = new TH1F( "hDataEmb_3Prong_TriggerBugUp","Embedded_TriggerBugUp"          , nBins , bins.GetArray());         hDataEmb_3Prong_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_3Prong_TriggerBugDown  = new TH1F( "hDataEmb_3Prong_TriggerBugDown","Embedded_TriggerBugDown"          , nBins , bins.GetArray());         hDataEmb_3Prong_TriggerBugDown->SetFillColor(kOrange-4);
  ...
  TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp = new TH1F( "hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp","Embedded no TTbarEmb subtracted_1Prong0Pi0_TriggerBugUp", nBins ,bins.GetArray());hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown = new TH1F( "hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown","Embedded no TTbarEmb subtracted_1Prong0Pi0_TriggerBugDown", nBins ,bins.GetArray());hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown->SetFillColor(kOrange-4);
  ...
  TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp = new TH1F( "hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp","Embedded no TTbarEmb subtracted_1Prong1Pi0_TriggerBugUp", nBins ,bins.GetArray());hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown = new TH1F( "hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown","Embedded no TTbarEmb subtracted_1Prong1Pi0_TriggerBugDown", nBins ,bins.GetArray());hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown->SetFillColor(kOrange-4);
  ...
  TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugUp = new TH1F( "hDataEmb_NotSubtracted_3Prong_TriggerBugUp","Embedded no TTbarEmb subtracted_3Prong_TriggerBugUp", nBins ,bins.GetArray());hDataEmb_NotSubtracted_3Prong_TriggerBugUp->SetFillColor(kOrange-4);
  TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugDown = new TH1F( "hDataEmb_NotSubtracted_3Prong_TriggerBugDown","Embedded no TTbarEmb subtracted_3Prong_TriggerBugDown", nBins ,bins.GetArray());hDataEmb_NotSubtracted_3Prong_TriggerBugDown->SetFillColor(kOrange-4);
  ...
  TH1F* hZmm_TriggerBugUp      = new TH1F( "hZmm_TriggerBugUp"    ,"Z+jets, mu->tau_TriggerBugUp"   , nBins , bins.GetArray());         hZmm_TriggerBugUp->SetFillColor(kBlue-2);
  TH1F* hZmm_TriggerBugDown      = new TH1F( "hZmm_TriggerBugDown"    ,"Z+jets, mu->tau_TriggerBugDown"   , nBins , bins.GetArray());         hZmm_TriggerBugDown->SetFillColor(kBlue-2);

  TH1F* hZmmLoose = new TH1F( "hZmmLoose","Z+jets, mu->tau"  , nBins , bins.GetArray());         hZmmLoose->SetFillColor(kBlue-2);
  TH1F* hZmmLoose_TriggerBugUp = new TH1F( "hZmmLoose_TriggerBugUp","Z+jets, mu->tau_TriggerBugUp"  , nBins , bins.GetArray());         hZmmLoose_TriggerBugUp->SetFillColor(kBlue-2);
  TH1F* hZmmLoose_TriggerBugDown = new TH1F( "hZmmLoose_TriggerBugDown","Z+jets, mu->tau_TriggerBugDown"  , nBins , bins.GetArray());         hZmmLoose_TriggerBugDown->SetFillColor(kBlue-2);
  ...
  TH1F* hZfakes_TriggerBugUp   = new TH1F( "hZfakes_TriggerBugUp" ,"Z+jets, jet to tau_TriggerBugUp", nBins , bins.GetArray());         hZfakes_TriggerBugUp->SetFillColor(kBlue-2);
  TH1F* hZfakes_TriggerBugDown   = new TH1F( "hZfakes_TriggerBugDown" ,"Z+jets, jet to tau_TriggerBugDown", nBins , bins.GetArray());         hZfakes_TriggerBugDown->SetFillColor(kBlue-2);
  ...
  TH1F* hTTbEmb_TriggerBugUp   = new TH1F( "hTTbEmb_TriggerBugUp" ,"ttbarEmbedded_TriggerBugUp"     , nBins , bins.GetArray());         hTTbEmb_TriggerBugUp->SetLineWidth(2); hTTbEmb_TriggerBugUp->SetLineColor(kMagenta);hTTbEmb->SetFillStyle(3004);
  TH1F* hTTbEmb_TriggerBugDown   = new TH1F( "hTTbEmb_TriggerBugDown" ,"ttbarEmbedded_TriggerBugDown"     , nBins , bins.GetArray());         hTTbEmb_TriggerBugDown->SetLineWidth(2); hTTbEmb_TriggerBugDown->SetLineColor(kMagenta);hTTbEmb->SetFillStyle(3004);
  ...
  TH1F* hTTbEmb_1Prong0Pi0_TriggerBugUp   = new TH1F( "hTTbEmb_1Prong0Pi0_TriggerBugUp" ,"ttbarEmbedded_1Prong0Pi0_TriggerBugUp"     , nBins , bins.GetArray());         hTTbEmb_1Prong0Pi0_TriggerBugUp->SetLineWidth(2); hTTbEmb_1Prong0Pi0_TriggerBugUp->SetLineColor(kMagenta);hTTbEmb_1Prong0Pi0_TriggerBugUp->SetFillStyle(3004);
  TH1F* hTTbEmb_1Prong0Pi0_TriggerBugDown   = new TH1F( "hTTbEmb_1Prong0Pi0_TriggerBugDown" ,"ttbarEmbedded_1Prong0Pi0_TriggerBugDown"     , nBins , bins.GetArray());         hTTbEmb_1Prong0Pi0_TriggerBugDown->SetLineWidth(2); hTTbEmb_1Prong0Pi0_TriggerBugDown->SetLineColor(kMagenta);hTTbEmb_1Prong0Pi0_TriggerBugDown->SetFillStyle(3004);
  ...
  TH1F* hTTbEmb_1Prong1Pi0_TriggerBugUp   = new TH1F( "hTTbEmb_1Prong1Pi0_TriggerBugUp" ,"ttbarEmbedded_1Prong1Pi0_TriggerBugUp"     , nBins , bins.GetArray());         hTTbEmb_1Prong1Pi0_TriggerBugUp->SetLineWidth(2); hTTbEmb_1Prong1Pi0_TriggerBugUp->SetLineColor(kMagenta);hTTbEmb_1Prong1Pi0_TriggerBugUp->SetFillStyle(3004);
  TH1F* hTTbEmb_1Prong1Pi0_TriggerBugDown   = new TH1F( "hTTbEmb_1Prong1Pi0_TriggerBugDown" ,"ttbarEmbedded_1Prong1Pi0_TriggerBugDown"     , nBins , bins.GetArray());         hTTbEmb_1Prong1Pi0_TriggerBugDown->SetLineWidth(2); hTTbEmb_1Prong1Pi0_TriggerBugDown->SetLineColor(kMagenta);hTTbEmb_1Prong1Pi0_TriggerBugDown->SetFillStyle(3004);
  ...
  TH1F* hTTbEmb_3Prong_TriggerBugUp   = new TH1F( "hTTbEmb_3Prong_TriggerBugUp" ,"ttbarEmbedded_3Prong_TriggerBugUp"     , nBins , bins.GetArray());         hTTbEmb_3Prong_TriggerBugUp->SetLineWidth(2); hTTbEmb_3Prong_TriggerBugUp->SetLineColor(kMagenta);hTTbEmb_3Prong_TriggerBugUp->SetFillStyle(3004);
  TH1F* hTTbEmb_3Prong_TriggerBugDown   = new TH1F( "hTTbEmb_3Prong_TriggerBugDown" ,"ttbarEmbedded_3Prong_TriggerBugDown"     , nBins , bins.GetArray());         hTTbEmb_3Prong_TriggerBugDown->SetLineWidth(2); hTTbEmb_3Prong_TriggerBugDown->SetLineColor(kMagenta);hTTbEmb_3Prong_TriggerBugDown->SetFillStyle(3004);
  ...
  TH1F* hWLooseBTag_TriggerBugUp                        = new TH1F( "hWLooseBTag_TriggerBugUp " ,  "W+jets (Loose b-Tag)_TriggerBugUp ", nBins , bins.GetArray());
  TH1F* hWLooseBTag_TriggerBugDown                        = new TH1F( "hWLooseBTag_TriggerBugDown " ,  "W+jets (Loose b-Tag)_TriggerBugDown ", nBins , bins.GetArray());

  TH1F* hWLooseBTagTight                       = new TH1F( "hWLooseBTagTight" ,  "W+jets (Loose b-Tag)", nBins , bins.GetArray());
  TH1F* hWLooseBTagTight_TriggerBugUp                       = new TH1F( "hWLooseBTagTight_TriggerBugUp" ,  "W+jets (Loose b-Tag)_TriggerBugUp", nBins , bins.GetArray());
  TH1F* hWLooseBTagTight_TriggerBugDown                       = new TH1F( "hWLooseBTagTight_TriggerBugDown" ,  "W+jets (Loose b-Tag)_TriggerBugDown", nBins , bins.GetArray());
  ...
  */
  ...
  TString pathToFile    = "/data_CMS/cms/htautau/PostMoriond/NTUPLES_19Dec14/MuTau/";
//   TString pathToFile    = "/data_CMS/cms/htautau/PostMoriond/NTUPLES_OlivierTES_TauSpinner/MuTau/";
  ...
  backgroundDYForInclusiveNorm   ->Add(pathToFileDY+"/nTupleDYJetsTauTau_tauPolarOff_MuTau_"+fileAnalysis+".root");
  //
  ...
  if(!FastMode) backgroundDY      ->Add(pathToFileDY+"/nTupleDYJetsZTTL_MuTau_"+fileAnalysis+".root");//fm
  if(!FastMode) backgroundDY      ->Add(pathToFileDY+"/nTupleDYJetsZTTJ_MuTau_"+fileAnalysis+".root");//fm
  if(!FastMode) backgroundDY      ->Add(pathToFileDY+"/nTupleDYJetsMuToTau_MuTau_"+fileAnalysis+".root");//fm
  if(!FastMode) backgroundDY      ->Add(pathToFileDY+"/nTupleDYJetsJetToTau_MuTau_"+fileAnalysis+".root");//fm
  ...
  if(!FastMode) backgroundTTbarEmb->Add(pathToFile+"nTupleTTJets-Embedded_p*_MuTau_"+fileAnalysis+".root");//fm
  //
  ...
  if(DOSPLIT) {
    ...
    if(!version_.Contains("NoDYExcl")) {
      ...
      if(!FastMode) backgroundDYTauTauLL->Add(pathToFileDY+"/nTupleDYJetsZTTL_MuTau_"    +fileAnalysis+".root");//was uncommented

      if(!FastMode) backgroundDYTauTauJJ->Add(pathToFileDY+"/nTupleDYJets*JetsZTTJ_MuTau_"    +fileAnalysis+".root");//was uncommented
      if(!FastMode) backgroundDYTauTauJJ->Add(pathToFileDY+"/nTupleDYJetsZTTJ_MuTau_"    +fileAnalysis+".root");//was uncommented

      if(!FastMode) backgroundDYMutoTau ->Add(pathToFileDY+"/nTupleDYJets*JetsMuToTau_MuTau_" +fileAnalysis+".root");//was uncommented
      if(!FastMode) backgroundDYMutoTau ->Add(pathToFileDY+"/nTupleDYJetsMuToTau_MuTau_" +fileAnalysis+".root");//was uncommented

      if(!FastMode) backgroundDYJtoTau  ->Add(pathToFileDY+"/nTupleDYJets*JetsJetToTau_MuTau_"+fileAnalysis+".root");//was uncommented
      if(!FastMode) backgroundDYJtoTau  ->Add(pathToFileDY+"/nTupleDYJetsJetToTau_MuTau_"+fileAnalysis+".root");//was uncommented
...
//   const int nVarious = 13;
  ...
  TString treeNamesVarious[nVarious]={"SS","WJets","Data","W3Jets","TTbar","Others","DYToTauTau","DYToTauTauLL","DYToTauTauJJ","DYMutoTau","DYJtoTau","Embedded","TTbarEmbedded","DYForInclusiveNorm"};
...
//   TCut antiele("tightestAntiEMVA5WP > 0");
  ...
  */
  ...
  TCut sbinEmbeddingPreselForEmbeddingNormalization  = lpt && lID && tpt && tiso  && tdecaymode && antimu && "tightestAntiECutWP > 0" && liso  && lveto && selection               ;
  ...
  TCut sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization = lpt && lID && tpt && tiso  && tdecaymode && antimu && "tightestAntiECutWP > 0" && liso  && lveto && selection && diTauCharge                          ;
  ...
  TCut sbinPZetaRelInclusiveForEmbeddingNormalization             = lpt && lID && tpt && tiso  && tdecaymode && antimu && "tightestAntiECutWP > 0" && liso  && lveto && selection && diTauCharge            && hltevent   ;
...
//  	if(currentName.Contains("DYToTauTau") && !currentName.Contains("DYToTauTauLL") && !currentName.Contains("DYToTauTauJJ")){
	if(currentName.Contains("DYForInclusiveNorm")){
	  //Nominal
	  float NormDYToTauTau = 0.;//here
	  drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], variable, NormDYToTauTau, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
// 	  drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], variable, NormDYToTauTau, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
...
// 	  cout<<"***** ExtrapolationFactorZFromSideband = "<<ExtrapolationFactorZFromSideband<<"*****"<<endl;
	  ...
	  //TriggerBugUp
	  h1->Reset() ; hCleaner->Reset();
	  float NormDYToTauTau_TriggerBugUp = 0.;
	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], variable, NormDYToTauTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
// 	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], variable, NormDYToTauTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
// 	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYToTauTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
	  hZtt_TriggerBugUp->Add(h1,1.);
// 	  hZtt_TriggerBugUp->Add(h1, ExtrapolationFactorZFromSideband);
	  float NormDYToTauTauLL_TriggerBugUp = 0.;
	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN, mapAllTrees["DYToTauTauLL"], variable, NormDYToTauTauLL_TriggerBugUp, Error,   Lumi*lumiCorrFactor*hltEff_/1000., hCleaner, sbin, 1);
          hZtt_TriggerBugUp->Add(hCleaner, 1.0);

	  //TriggerBugDown
	  h1->Reset() ; hCleaner->Reset();
	  float NormDYToTauTau_TriggerBugDown = 0.;
	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], variable, NormDYToTauTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
// 	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], variable, NormDYToTauTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
// 	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYToTauTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbin, 1);
...
// 	  hZtt_TriggerBugDown->Add(h1, ExtrapolationFactorZFromSideband);
	  ...
	  drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN, mapAllTrees["DYToTauTauLL"], variable, NormDYToTauTauLL_TriggerBugDown, Error,   Lumi*lumiCorrFactor*hltEff_/1000., hCleaner, sbin, 1);
          hZtt_TriggerBugDown->Add(hCleaner, 1.0);

	  //fine binning for MSSM
	  if(selection_.find("bTag")!=string::npos){
	    hCleanerfb->Reset(); float NormDYToTauTau_fb = 0.;
	    drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], variable, NormDYToTauTau_fb, Error,  Lumi*lumiCorrFactor*hltEff_/1000., hCleanerfb, sbin, 1);
// 	    drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], variable, NormDYToTauTau_fb, Error,  Lumi*lumiCorrFactor*hltEff_/1000., hCleanerfb, sbin, 1);
...
// 	    hZtt_fb->Add(hCleanerfb, ExtrapolationFactorZFromSideband);
	...
	if(currentName.Contains("TTbar")){
	  if(selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos){ 
	    ...
	    drawHistogram(sbinPresel,sbinCat,"MCTTJets_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormTTjets_TriggerBugUp,     Error,   Lumi*TTxsectionRatio*scaleFactorTTOSWJets*hltEff_/1000., h1, sbin, 1);
	    hTTb_TriggerBugUp->Add(h1, 1.0);	    

	    //TriggerBugDown
	    float NormTTjets_TriggerBugDown = 0.;
	    drawHistogram(sbinPresel,sbinCat,"MCTTJets_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormTTjets_TriggerBugDown,     Error,   Lumi*TTxsectionRatio*scaleFactorTTOSWJets*hltEff_/1000., h1, sbin, 1);
...
// 	  if(removeMtCut) h1->Scale(OSWinSidebandRegionDATAW3Jets/OSWinSidebandRegionMCW3Jets);//comented 021214
	  ...
	  for(Int_t ibin = 1 ; ibin <= h1->GetNbinsX() ; ++ibin) h1->SetBinError(ibin, h1->GetBinError(ibin)*pow(LooseToTightRatioUp,0.5));
	  ...
	  ////increase the error using loose to tight ratio
	  for(Int_t ibin = 1 ; ibin <= h1->GetNbinsX() ; ++ibin) h1->SetBinError(ibin, h1->GetBinError(ibin)*pow(LooseToTightRatioDown,0.5));
	  ...
	  evaluateWextrapolation(mapAllTrees, version_,analysis_, "MC_WJet_TriggerBugUp", RUN, "OS", false, selection_,
	  ...
	  drawHistogram(sbinPresel,sbinCat,"MC_WJet_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormWJets_TriggerBugUp, Error,   Lumi*hltEff_/1000., h1, sbin, 1);
	  ...
	  //Nominal shape in Loose tau iso
	  h1->Reset();
	  drawHistogram(sbinLtisoPresel,sbinCat,"MC_WJet_TriggerBugUp_LooseTightWCorr", version_,analysis_, RUN,currentTree, variable, NormWJets_TriggerBugUp, Error,   Lumi*hltEff_/1000., h1, sbinLtiso, 1);
	  ...
	  evaluateWextrapolation(mapAllTrees, version_,analysis_, "MC_WJet_TriggerBugDown", RUN, "OS", false, selection_,
	  ...
	  drawHistogram(sbinPresel,sbinCat,"MC_WJet_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormWJets_TriggerBugDown, Error,   Lumi*hltEff_/1000., h1, sbin, 1);
	  ...
	  //Nominal shape in Loose tau iso
	  h1->Reset();
	  drawHistogram(sbinLtisoPresel,sbinCat,"MC_WJet_TriggerBugDown_LooseTightWCorr", version_,analysis_, RUN,currentTree, variable, NormWJets_TriggerBugDown, Error,   Lumi*hltEff_/1000., h1, sbinLtiso, 1);
	  ...
	  if(selection_.find("vbfTight")!=string::npos){
	    ...
	    //TriggerBugUp
	    float NormDYMutoTau_TriggerBugUp = 0.; 
	    if(useZDataMC) 
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin,  1); 
	    else  
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., hCleaner, sbinInclusive, 1);
	    ...
	    //TriggerBugDown
	    float NormDYMutoTau_TriggerBugDown = 0.; 
	    if(useZDataMC) 
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin,  1); 
	    else  
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., hCleaner, sbinInclusive, 1);
	    ...
	    if(useZDataMC)
	      drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin, 1);
	    else drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    hZmm->Add(h1, 1.0);
	    hZfakes->Add(h1,1.0);
	    ...
	    if(useZDataMC)
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin, 1);
	    else drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugUp, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    ...
	    if(useZDataMC)
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin, 1);
	    else drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYMutoTau_TriggerBugDown, Error,   Lumi*lumiCorrFactor*MutoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	  ...
	  drawHistogram(sbinPresel,sbinCat,"MC", version_,analysis_, RUN,mapAllTrees["DYToTauTauLL"], variable, NormDYToTauTauLL_fb, Error, Lumi*lumiCorrFactor*hltEff_/1000., hCleanerfb, sbin, 1);
	  //Mapping it to ZL
	  if(hCleanerfb) hZmm_fb->Add(hCleanerfb, 1.0);
	  ...
	  if(selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos){   
	    ...
	    hCleaner->Reset();
	    if(useZDataMC) drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugUp, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., hCleaner, sbinInclusive, 1); 
	    else drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugUp, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*hltEff_/1000., hCleaner, sbinInclusive, 1); 

	    NormDYJtoTau_TriggerBugUp = 0.;  
	    if(useZDataMC)
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugUp, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin, 1);  
	    else
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugUp, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    hCleaner->Scale(h1->Integral()/hCleaner->Integral()); 
	    ...
	    drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYToTauTauJJ"], variable, NormDYTTJtoTau_TriggerBugUp, Error,    Lumi*lumiCorrFactor*hltEff_/1000., hCleaner, sbin, 1);
	    if(hCleaner) {
	      hZmj_TriggerBugUp->Add(hCleaner, 1.0);
	      hZfakes_TriggerBugUp->Add(hCleaner,1.0);
	      hEWK_TriggerBugUp->Add(hCleaner,1.0);
	    ...
	    hCleaner->Reset();
	    if(useZDataMC) drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugDown, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., hCleaner, sbinInclusive, 1); 
	    else drawHistogram(sbinPresel,bTagLoose,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugDown, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*hltEff_/1000., hCleaner, sbinInclusive, 1); 

	    NormDYJtoTau_TriggerBugDown = 0.;  
	    if(useZDataMC)
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugDown, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*ExtrapolationFactorZDataMC*hltEff_/1000., h1, sbin, 1);  
	    else
	      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormDYJtoTau_TriggerBugDown, Error,    Lumi*lumiCorrFactor*JtoTauCorrectionFactor*hltEff_/1000., h1, sbin, 1);
	    hCleaner->Scale(h1->Integral()/hCleaner->Integral()); 
	    ...
	    drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYToTauTauJJ"], variable, NormDYTTJtoTau_TriggerBugDown, Error,    Lumi*lumiCorrFactor*hltEff_/1000., hCleaner, sbin, 1);
	    if(hCleaner) {
	      hZmj_TriggerBugDown->Add(hCleaner, 1.0);
	      hZfakes_TriggerBugDown->Add(hCleaner,1.0);
	      hEWK_TriggerBugDown->Add(hCleaner,1.0);
	  ...
	  if(selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos){    
	    ...
	    drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormOthers_TriggerBugUp , Error,     Lumi*hltEff_/1000., h1, sbin, 1);
	    hVV_TriggerBugUp->Add(h1, 1.0);
	    hEWK_TriggerBugUp->Add(h1,1.0);

	    //TriggerBugDown
	    float NormOthers_TriggerBugDown = 0.;
	    drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormOthers_TriggerBugDown , Error,     Lumi*hltEff_/1000., h1, sbin, 1);
	  ...
	  if(currentName.Contains("GGFH")) drawHistogram(sbinPresel,sbinCat,"MCGGFH", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, sbin, 1);
	  ...
	  for(int iP=0 ; iP<nProd ; iP++)
	      ...
	      for(int iM=0 ; iM<nMasses ; iM++)
		{
		  if(currentName.Contains(nameProd[iP]+nameMasses[iM]))
		    {
		      if(currentName.Contains("GGFH")) drawHistogram(sbinPresel,sbinCat,"MCGGFH_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, sbin, 1);
		      else drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, sbin, 1);
	  ...
	  for(int iP=0 ; iP<nProd ; iP++)
	      ...
	      for(int iM=0 ; iM<nMasses ; iM++)
		{
		  if(currentName.Contains(nameProd[iP]+nameMasses[iM]))
		    {
		      if(currentName.Contains("GGFH")) drawHistogram(sbinPresel,sbinCat,"MCGGFH_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, sbin, 1);
		      drawHistogram(sbinPresel,sbinCat,"MC_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, sbin, 1);
			...
			if(currentName==ProcessName)
			  {
			    ...
			    drawHistogram(sbinPresel,sbinCat,"MCSUSY_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, (sbin&&HWidth), 1);
			...
			if(currentName==ProcessName)
			  {
			    ...
			    drawHistogram(sbinPresel,sbinCat,"MCSUSY_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormSign, Error,    Lumi*hltEff_/1000., h1, (sbin&&HWidth), 1);
	...
	if(!currentName.Contains("TTbarEmbedded")){
	  if(selection_.find("vbf")!=string::npos && selection_.find("novbf")==string::npos){
	    ...
	    */
	    ...
	    // sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization
	    drawHistogram(sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization,sbinCatIncl,"Embed", version_,analysis_, RUN,currentTree, "0", NormEmbedInclusive,  Error, 1.0 , temp_histo_counter, sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization, 1);
...
// 	    
	    ...
	    float NormZTTInclusive = 0.;//sbinEmbeddingPreselForEmbeddingNormalization
	    drawHistogram(sbinEmbeddingPreselForEmbeddingNormalization,sbinCatIncl,"MC", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], "0", NormZTTInclusive,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
	    ...
	    drawHistogram(sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization,sbinCatIncl, "MCTTJetsEmb",version_,analysis_,RUN, backgroundTTbarEmb, "0", NormTTjetsEmbInclusive,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinPZetaRelEmbeddingInclusive,sbinCatIncl, "MCTTJetsEmb",version_,analysis_,RUN, backgroundTTbarEmb, "0", NormTTjetsEmbInclusive,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
	    ...
	    drawHistogram(sbinEmbeddingPreselForEmbeddingNormalization,sbinCatIncl,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, "0", NormEmbedInclusive_TriggerBugUp,  Error, 1.0 , temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
// 	    drawHistogram(sbinPZetaRelEmbeddingInclusive,sbinCatIncl,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, "0", NormEmbedInclusive_TriggerBugUp,  Error, 1.0 , temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();

	    float NormZTTInclusive_TriggerBugUp = 0.;
	    drawHistogram(sbinEmbeddingPreselForEmbeddingNormalization,sbinCatIncl,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive_TriggerBugUp,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive_TriggerBugUp,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC_TriggerBugUp", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], "0", NormZTTInclusive_TriggerBugUp,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();	    

	    float NormTTjetsEmbInclusive_TriggerBugUp = 0.;
	    drawHistogram(sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization,sbinCatIncl, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, "0", NormTTjetsEmbInclusive_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinPZetaRelEmbeddingInclusive,sbinCatIncl, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, "0", NormTTjetsEmbInclusive_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();
	    ...
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_TriggerBugUp,  Error, 1.0 , h1,  sbinEmbedding  ,1);
	    TH1F* h_Emb_category_TriggerBugUp = (TH1F*)h1->Clone("h_Emb_category_TriggerBugUp");
	    h1->Reset();

	    float NormTTjetsEmbNew_TriggerBugUp = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding, 1);
	    ...
	    drawHistogram(sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization,sbinCatIncl,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, "0", NormEmbedInclusive_TriggerBugDown,  Error, 1.0 , temp_histo_counter, sbinPZetaRelEmbeddingInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinPZetaRelEmbeddingInclusive,sbinCatIncl,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, "0", NormEmbedInclusive_TriggerBugDown,  Error, 1.0 , temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();

	    float NormZTTInclusive_TriggerBugDown = 0.;
	    drawHistogram(sbinEmbeddingPreselForEmbeddingNormalization,sbinCatIncl,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive_TriggerBugDown,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusiveForEmbeddingNormalization, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYForInclusiveNorm"], "0", NormZTTInclusive_TriggerBugDown,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
// 	    drawHistogram(sbinEmbeddingPresel,sbinCatIncl,"MC_TriggerBugDown", version_,analysis_, RUN,mapAllTrees["DYToTauTau"], "0", NormZTTInclusive_TriggerBugDown,   Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();	    

	    float NormTTjetsEmbInclusive_TriggerBugDown = 0.;
	    drawHistogram(sbinPZetaRelEmbeddingInclusive,sbinCatIncl, "MCTTJetsEmb_TriggerBugDown",version_,analysis_,RUN, backgroundTTbarEmb, "0", NormTTjetsEmbInclusive_TriggerBugDown,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., temp_histo_counter, sbinPZetaRelEmbeddingInclusive, 1);
	    temp_histo_counter->Reset();
	    h1->Reset();
	    ...
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_TriggerBugDown,  Error, 1.0 , h1,  sbinEmbedding  ,1);
	    TH1F* h_Emb_category_TriggerBugDown = (TH1F*)h1->Clone("h_Emb_category_TriggerBugDown");
	    h1->Reset();

	    float NormTTjetsEmbNew_TriggerBugDown = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugDown",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_TriggerBugDown,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding, 1);
	    ...
	    //1-prong + 0Pi0 TriggerBugUp
	    float NormEmbedNew_1Prong0Pi0_TriggerBugUp = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_1Prong0Pi0_TriggerBugUp,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_1Prong0Pi0_TriggerBugUp = (TH1F*)h1->Clone("h_Emb_category_1Prong0Pi0_TriggerBugUp");
	    h1->Reset();

	    float NormTTjetsEmbNew_1Prong0Pi0_TriggerBugUp = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_1Prong0Pi0_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugUp = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugUp");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_1Prong0Pi0_TriggerBugUp = (TH1F*)h_Emb_category_1Prong0Pi0_TriggerBugUp->Clone("h_ZTT_Emb_category_1Prong0Pi0_TriggerBugUp");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugUp, NormZTTInclusive_TriggerBugUp, NormTTjetsEmbInclusive_TriggerBugUp, h_ZTT_Emb_category_1Prong0Pi0_TriggerBugUp, h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugUp);
	    hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp = (TH1F*)h_Emb_category_1Prong0Pi0_TriggerBugUp->Clone("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp");
	    hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    hTTbEmb_1Prong0Pi0_TriggerBugUp = (TH1F*)h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugUp->Clone("hTTbEmb_1Prong0Pi0_TriggerBugUp");
	    hDataEmb_1Prong0Pi0_TriggerBugUp = (TH1F*)h_ZTT_Emb_category_1Prong0Pi0_TriggerBugUp->Clone("hDataEmb_1Prong0Pi0_TriggerBugUp");

	    //1-prong + 0Pi0 TriggerBugDown
	    float NormEmbedNew_1Prong0Pi0_TriggerBugDown = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_1Prong0Pi0_TriggerBugDown,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_1Prong0Pi0_TriggerBugDown = (TH1F*)h1->Clone("h_Emb_category_1Prong0Pi0_TriggerBugDown");
	    h1->Reset();

	    float NormTTjetsEmbNew_1Prong0Pi0_TriggerBugDown = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugDown",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_1Prong0Pi0_TriggerBugDown,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugDown = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugDown");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_1Prong0Pi0_TriggerBugDown = (TH1F*)h_Emb_category_1Prong0Pi0_TriggerBugDown->Clone("h_ZTT_Emb_category_1Prong0Pi0_TriggerBugDown");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugDown, NormZTTInclusive_TriggerBugDown, NormTTjetsEmbInclusive_TriggerBugDown, h_ZTT_Emb_category_1Prong0Pi0_TriggerBugDown, h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugDown);
	    hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown = (TH1F*)h_Emb_category_1Prong0Pi0_TriggerBugDown->Clone("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown");
	    hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    hTTbEmb_1Prong0Pi0_TriggerBugDown = (TH1F*)h_TTbarMC_Emb_category_1Prong0Pi0_TriggerBugDown->Clone("hTTbEmb_1Prong0Pi0_TriggerBugDown");
	    hDataEmb_1Prong0Pi0_TriggerBugDown = (TH1F*)h_ZTT_Emb_category_1Prong0Pi0_TriggerBugDown->Clone("hDataEmb_1Prong0Pi0_TriggerBugDown");
	    ...
	    //1-prong + 1Pi0 TriggerBugUp
	    float NormEmbedNew_1Prong1Pi0_TriggerBugUp = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_1Prong1Pi0_TriggerBugUp,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_1Prong1Pi0_TriggerBugUp = (TH1F*)h1->Clone("h_Emb_category_1Prong1Pi0_TriggerBugUp");
	    h1->Reset();

	    float NormTTjetsEmbNew_1Prong1Pi0_TriggerBugUp = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_1Prong1Pi0_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugUp = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugUp");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_1Prong1Pi0_TriggerBugUp = (TH1F*)h_Emb_category_1Prong1Pi0_TriggerBugUp->Clone("h_ZTT_Emb_category_1Prong1Pi0_TriggerBugUp");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugUp, NormZTTInclusive_TriggerBugUp, NormTTjetsEmbInclusive_TriggerBugUp, h_ZTT_Emb_category_1Prong1Pi0_TriggerBugUp, h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugUp);
	    hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp = (TH1F*)h_Emb_category_1Prong1Pi0_TriggerBugUp->Clone("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp");
	    hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    hTTbEmb_1Prong1Pi0_TriggerBugUp = (TH1F*)h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugUp->Clone("hTTbEmb_1Prong1Pi0_TriggerBugUp");
	    hDataEmb_1Prong1Pi0_TriggerBugUp = (TH1F*)h_ZTT_Emb_category_1Prong1Pi0_TriggerBugUp->Clone("hDataEmb_1Prong1Pi0_TriggerBugUp");

	    //1-prong + 1Pi0 TriggerBugDown
	    float NormEmbedNew_1Prong1Pi0_TriggerBugDown = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_1Prong1Pi0_TriggerBugDown,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_1Prong1Pi0_TriggerBugDown = (TH1F*)h1->Clone("h_Emb_category_1Prong1Pi0_TriggerBugDown");
	    h1->Reset();

	    float NormTTjetsEmbNew_1Prong1Pi0_TriggerBugDown = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugDown",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_1Prong1Pi0_TriggerBugDown,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugDown = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugDown");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_1Prong1Pi0_TriggerBugDown = (TH1F*)h_Emb_category_1Prong1Pi0_TriggerBugDown->Clone("h_ZTT_Emb_category_1Prong1Pi0_TriggerBugDown");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugDown, NormZTTInclusive_TriggerBugDown, NormTTjetsEmbInclusive_TriggerBugDown, h_ZTT_Emb_category_1Prong1Pi0_TriggerBugDown, h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugDown);
	    hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown = (TH1F*)h_Emb_category_1Prong1Pi0_TriggerBugDown->Clone("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown");
	    hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    hTTbEmb_1Prong1Pi0_TriggerBugDown = (TH1F*)h_TTbarMC_Emb_category_1Prong1Pi0_TriggerBugDown->Clone("hTTbEmb_1Prong1Pi0_TriggerBugDown");
	    hDataEmb_1Prong1Pi0_TriggerBugDown = (TH1F*)h_ZTT_Emb_category_1Prong1Pi0_TriggerBugDown->Clone("hDataEmb_1Prong1Pi0_TriggerBugDown");
	    ...
	    //3-prong TriggerBugUp
	    float NormEmbedNew_3Prong_TriggerBugUp = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugUp", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_3Prong_TriggerBugUp,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_3Prong_TriggerBugUp = (TH1F*)h1->Clone("h_Emb_category_3Prong_TriggerBugUp");
	    h1->Reset();

	    float NormTTjetsEmbNew_3Prong_TriggerBugUp = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugUp",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_3Prong_TriggerBugUp,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_3Prong_TriggerBugUp = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_3Prong_TriggerBugUp");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_3Prong_TriggerBugUp = (TH1F*)h_Emb_category_3Prong_TriggerBugUp->Clone("h_ZTT_Emb_category_3Prong_TriggerBugUp");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugUp, NormZTTInclusive_TriggerBugUp, NormTTjetsEmbInclusive_TriggerBugUp, h_ZTT_Emb_category_3Prong_TriggerBugUp, h_TTbarMC_Emb_category_3Prong_TriggerBugUp);
	    hDataEmb_NotSubtracted_3Prong_TriggerBugUp = (TH1F*)h_Emb_category_3Prong_TriggerBugUp->Clone("hDataEmb_NotSubtracted_3Prong_TriggerBugUp");
	    hDataEmb_NotSubtracted_3Prong_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    h_TTbarMC_Emb_category_3Prong_TriggerBugUp->Scale(Weight_From_ZTT_MC_TriggerBugUp);
	    hTTbEmb_3Prong_TriggerBugUp = (TH1F*)h_TTbarMC_Emb_category_3Prong_TriggerBugUp->Clone("hTTbEmb_3Prong_TriggerBugUp");
	    hDataEmb_3Prong_TriggerBugUp = (TH1F*)h_ZTT_Emb_category_3Prong_TriggerBugUp->Clone("hDataEmb_3Prong_TriggerBugUp");

	    //3-prong TriggerBugDown
	    float NormEmbedNew_3Prong_TriggerBugDown = 0.;
	    decayModeRequirement = "decayMode==0";
	    drawHistogram(sbinEmbeddingPresel,sbinCat,"Embed_TriggerBugDown", version_,analysis_, RUN,currentTree, variable, NormEmbedNew_3Prong_TriggerBugDown,  Error, 1.0 , h1,  sbinEmbedding&&decayModeRequirement  ,1);
	    TH1F* h_Emb_category_3Prong_TriggerBugDown = (TH1F*)h1->Clone("h_Emb_category_3Prong_TriggerBugDown");
	    h1->Reset();

	    float NormTTjetsEmbNew_3Prong_TriggerBugDown = 0.;
	    drawHistogram(sbinEmbeddingPresel,sbinCat, "MCTTJetsEmb_TriggerBugDown",version_,analysis_,RUN, backgroundTTbarEmb, variable, NormTTjetsEmbNew_3Prong_TriggerBugDown,     Error,   Lumi*lumiCorrFactor*hltEff_/1000., h1, sbinEmbedding&&decayModeRequirement, 1);
	    TH1F* h_TTbarMC_Emb_category_3Prong_TriggerBugDown = (TH1F*)h1->Clone("h_TTbarMC_Emb_category_3Prong_TriggerBugDown");
	    h1->Reset(); 

	    TH1F* h_ZTT_Emb_category_3Prong_TriggerBugDown = (TH1F*)h_Emb_category_3Prong_TriggerBugDown->Clone("h_ZTT_Emb_category_3Prong_TriggerBugDown");
	    EvaluateZTTEmb(NormEmbedInclusive_TriggerBugDown, NormZTTInclusive_TriggerBugDown, NormTTjetsEmbInclusive_TriggerBugDown, h_ZTT_Emb_category_3Prong_TriggerBugDown, h_TTbarMC_Emb_category_3Prong_TriggerBugDown);
	    hDataEmb_NotSubtracted_3Prong_TriggerBugDown = (TH1F*)h_Emb_category_3Prong_TriggerBugDown->Clone("hDataEmb_NotSubtracted_3Prong_TriggerBugDown");
	    hDataEmb_NotSubtracted_3Prong_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    h_TTbarMC_Emb_category_3Prong_TriggerBugDown->Scale(Weight_From_ZTT_MC_TriggerBugDown);
	    hTTbEmb_3Prong_TriggerBugDown = (TH1F*)h_TTbarMC_Emb_category_3Prong_TriggerBugDown->Clone("hTTbEmb_3Prong_TriggerBugDown");
	    hDataEmb_3Prong_TriggerBugDown = (TH1F*)h_ZTT_Emb_category_3Prong_TriggerBugDown->Clone("hDataEmb_3Prong_TriggerBugDown");
  ...
  */
  ...
  hTTbEmb_1Prong0Pi0_TriggerBugUp->Write();
  hTTbEmb_1Prong0Pi0_TriggerBugDown->Write();
  hTTbEmb_1Prong1Pi0->Write();
  hTTbEmb_1Prong1Pi0_TriggerBugUp->Write();
  hTTbEmb_1Prong1Pi0_TriggerBugDown->Write();
  hTTbEmb_3Prong->Write();
  hTTbEmb_3Prong_TriggerBugUp->Write();
  hTTbEmb_3Prong_TriggerBugDown->Write();
  hTTbEmb_fb->Write();
  hZtt->Write();
  ...
  hDataEmb_1Prong0Pi0_TriggerBugUp->Write();
  hDataEmb_1Prong0Pi0_TriggerBugDown->Write();
  hDataEmb_1Prong1Pi0->Write();
  hDataEmb_1Prong1Pi0_TriggerBugUp->Write();
  hDataEmb_1Prong1Pi0_TriggerBugDown->Write();
  hDataEmb_3Prong->Write();
  hDataEmb_3Prong_TriggerBugUp->Write();
  hDataEmb_3Prong_TriggerBugDown->Write();
  ...
  hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp->Write();
  hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown->Write();
  hDataEmb_NotSubtracted_1Prong1Pi0->Write();
  hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp->Write();
  hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown->Write();
  hDataEmb_NotSubtracted_3Prong->Write();
  hDataEmb_NotSubtracted_3Prong_TriggerBugUp->Write();
  hDataEmb_NotSubtracted_3Prong_TriggerBugDown->Write();
  //hDataEmb2->Write();
  hLooseIso1->Write();
  hLooseIso2->Write();
  hLooseIso3->Write();
  ...
  delete aStack;  delete hEWK; delete hSiml; delete hDataEmb; delete hDataEmb_TriggerBugUp; delete hDataEmb_TriggerBugDown; 
  delete hRatio; delete line;
