...
#iteration = 'Datacards_ControlPlots_211114'
...
#iteration = 'Datacards_Sync_281214'
#iteration = 'Datacards_Sync_140115'
#iteration = 'Datacards_ZttMC_160115'
#iteration = 'Datacards_Sync_200115'
...
iteration = 'Datacards_ZttMC_tauPolarOn_110215'
...
##     analyze(125,"inclusive"    ,""   ,"csvAllB","'b-discriminator'","units"            ,outputDir,40,0, 1.,5.0,1.0,0,2.,data, stream, version, useEmb);
##     analyze(125,"inclusive"    ,""   ,"ptAll","'Al jets p_{T}'","GeV"                  ,outputDir,27,20,300,5.0,1.0,0,1.2,data, stream, version, useEmb);
##     analyze(125,"inclusive"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);
...
##     analyze(125,"bTagLow"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);
...
##     analyze(125,"bTagHigh"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);
...
##     analyze(125,"nobTagLow"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);
...
##     analyze(125,"nobTagMedium"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);
...
##     analyze(125,"nobTagHigh"    ,""   ,"pZetaMVA","'pZetaMVA'","GeV"                  ,outputDir,150,-100.,500.,5.0,1.0,0,1.2,data, stream, version, useEmb);

##     analyze(125,"inclusive"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
##     analyze(125,"bTagLow"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
##     analyze(125,"bTagHigh"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
##     analyze(125,"nobTagLow"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
##     analyze(125,"nobTagMedium"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
##     analyze(125,"nobTagHigh"    ,"" ,"ptL1","'e p_{T}'","GeV"                           ,outputDir,-1,0   ,152,5.0,1.0,0,1.2  ,data,stream,version,useEmb);
