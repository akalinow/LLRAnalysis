...
def treeSkim( ana, sample, runInSeries=False):
    ...
    if runInSeries:
         ...
         configFileName = "./Configs/treeSkimmerMuTau_Fall14_%s_%s_cfg.py" % (sample,ana)
...
#os.system('python makeTreeSkimmerMuTau_Winter13.py')
os.system('python makeTreeSkimmerMuTau_Fall14.py')
...
ListFinalState = ['TauTau','JetToTau','MuToTau','ZTTJ']
