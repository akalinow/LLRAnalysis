...
//       hSgn1_PtDown->Scale(0.8*hSgn1->Integral()/hSgn1_PtDown->Integral()); 
      ...
      //TH1F* hSgn1_PtScaleUp = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleUp",mH_));//will be changed to this when POWHEG uncertainty is filled
      ...
      //TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleDown",mH_));//will be changed to this when POWHEG uncertainty is filled
...
//       TH1F* hSMGGFH125 = (TH1F*)fin->Get("hGGFH125");
	...
	hZmm_Up->SetName(Form("ZL%s"        ,"_CMS_htt_ZLScale_etau_8TeVUp"));
      ...
      TreatNegativeBinsDataEmb(hDataEmb, hDataEmb_NotSubtracted, hTTbarEmb);
      hDataEmb->SetName(Form("ZTT%s",suffix.c_str()));
      hDataEmb->Write(Form("ZTT%s",suffix.c_str()));
      ...
      TreatNegativeBinsDataEmb(hDataEmb_fb, hDataEmb_NotSubtracted_fb, hTTbarEmb_fb);
...
//   produceOne("Results_ABCD_AntiMu3Loose_AntiEle5Medium_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_FixedTrigger_171014",true);//was commented
