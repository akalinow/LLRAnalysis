...
options = {
    ...
    'ZZJetsTo2L2Nu' : {
    'inputFilePath'  : WorkdirLoc+'BackgroundsMC/ZZJetsTo2L2Nu-ElecTau-madgraph-PUS10_run/',
    ...
    ##Higgs MC
    'GGFH90' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH90-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH95' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH95-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH100' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH100-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH105' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH105-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH150' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH150-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH155' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH155-ElecTau-powheg-PUS10_run/',
    ...
    'GGFH160' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/GGFH160-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH90' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH90-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH95' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH95-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH100' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH100-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH105' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH105-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH150' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH150-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH155' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH155-ElecTau-powheg-PUS10_run/',
    ...
    'VBFH160' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VBFH160-ElecTau-powheg-PUS10_run/',
    ...
    'VH90' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH90-ElecTau-pythia-PUS10_run/',
    ...
    'VH95' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH95-ElecTau-pythia-PUS10_run/',
    ...
    'VH100' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH100-ElecTau-pythia-PUS10_run/',
    ...
    'VH105' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH105-ElecTau-pythia-PUS10_run/',
    ...
    'VH150' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH150-ElecTau-pythia-PUS10_run/',
    ...
    'VH155' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH155-ElecTau-pythia-PUS10_run/',
    ...
    'VH160' : {
    'inputFilePath'  : WorkdirLoc+'HiggsSM/VH160-ElecTau-pythia-PUS10_run/',
