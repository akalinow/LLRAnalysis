...
//   cout<<"h->Integral() = "<<h->Integral()<<endl;
  ...
  for(int i=1 ; i<=nBins+1 ; i++)
    {
      if(h->GetBinContent(i) < 0) {
	Double_t DistanceFrom0 = fabs(0.-h->GetBinContent(i));
	h->SetBinContent(i,0.);
	Double_t Error = sqrt(hData->GetBinError(i)*hData->GetBinError(i)+hTTbar->GetBinError(i)*hTTbar->GetBinError(i)+DistanceFrom0*DistanceFrom0);
...
void produce(   
	     ...
	     TString location  = "/data_CMS/cms/davignon/NtuplesProduction_NewTrees_NewTriggers/CMSSW_5_3_11_p6_TauSpinner/src/LLRAnalysis/Limits/bin/results/MuTau/"
  ...
  if(Displays) cout << "Now doing mass mH=" << mH_ << ", for variable " << variable_ << " analysis " << analysis_ << " and bin " << bin_ << endl;
  TFile* fin = 0;
...
//   useEmb = 0 ;
  ...
  if(Displays) cout << "Adding histos with suffix " << suffix << endl;
  TString dirName( Form("muTau_%s",binNameSpace.c_str()) );
  
  if(! (fTemplOut->cd( dirName.Data()  ) ) ){
    
    if(Displays) cout << "Editing the directory for bin and variable " << binNameSpace << ", " << variable_ << endl;
	...
	hSgn5->Write(Form("qqH_hww%d%s" ,mH_,suffix.c_str()));
      ...
      TH1F* hSgn1_Up = (TH1F*)fin->Get(Form("hSUSYEffTUpGGH%d",mH_));
      ...
      TH1F* hSgn1_Down = (TH1F*)fin->Get(Form("hSUSYEffTDownGGH%d",mH_));
      ...
      TH1F* hSgn1_PtScaleUp = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleUp",mH_));
      //       TH1F* hSgn1_PtScaleUp = (TH1F*)fin->Get(Form("hSUSYGGH%d",mH_));
      hSgn1_PtScaleUp->SetName(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVUp",mH_));
      hSgn1_PtScaleUp->Write(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVUp",mH_));

      TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleDown",mH_));
      //       TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%d",mH_));
      hSgn1_PtScaleDown->SetName(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVDown",mH_));
      hSgn1_PtScaleDown->Write(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVDown",mH_));

      // CMS_htt_eff_trig_mssmHigh_ltau_8TeV
      TH1F* hSgn1_TriggerBugUp = (TH1F*)fin->Get(Form("hSUSYGGH%d_TriggerBugUp",mH_));
      hSgn1_TriggerBugUp->SetName(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
      hSgn1_TriggerBugUp->Write(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));

      TH1F* hSgn1_TriggerBugDown = (TH1F*)fin->Get(Form("hSUSYGGH%d_TriggerBugDown",mH_));
      hSgn1_TriggerBugDown->SetName(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      hSgn1_TriggerBugDown->Write(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      ...
      TH1F* hSgn2_Up = (TH1F*)fin->Get(Form("hSUSYEffTUpBBH%d",mH_));
      ...
      TH1F* hSgn2_Down = (TH1F*)fin->Get(Form("hSUSYEffTDownBBH%d",mH_));
      ...
      TH1F* hSgn2_TriggerBugUp = (TH1F*)fin->Get(Form("hSUSYBBH%d_TriggerBugUp",mH_));
      hSgn2_TriggerBugUp->SetName(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
      hSgn2_TriggerBugUp->Write(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));

      TH1F* hSgn2_TriggerBugDown = (TH1F*)fin->Get(Form("hSUSYBBH%d_TriggerBugDown",mH_));
      hSgn2_TriggerBugDown->SetName(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      hSgn2_TriggerBugDown->Write(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      ...
      //hSMVBFH125->Write(" shiftedqqH_SM125");
      ...
      //SM signal shifted up and down by mssmHigh high pT uncertainty
      TH1F* hSMGGFH125_mssmHigh_Up = (TH1F*)fin->Get("hSMEffTUpGGFH125");
      hSMGGFH125_mssmHigh_Up->SetName("ggH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp" );
      hSMGGFH125_mssmHigh_Up->Write("ggH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp");

      TH1F* hSMGGFH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownGGFH125");
      hSMGGFH125_mssmHigh_Down->SetName("ggH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown" );
      hSMGGFH125_mssmHigh_Down->Write("ggH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown");

      TH1F* hSMVBFH125_mssmHigh_Up = (TH1F*)fin->Get("hSMEffTUpVBFH125");
      hSMVBFH125_mssmHigh_Up->SetName("qqH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp" );
      hSMVBFH125_mssmHigh_Up->Write("qqH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp");

      TH1F* hSMVBFH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownVBFH125");
      hSMVBFH125_mssmHigh_Down->SetName("qqH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown" );
      hSMVBFH125_mssmHigh_Down->Write("qqH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown");

      TH1F* hSMVH125_mssmHigh_Up = (TH1F*)fin->Get("hSMEffTUpVH125");
      hSMVH125_mssmHigh_Up->SetName("VH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp" );
      hSMVH125_mssmHigh_Up->Write("VH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVUp");

      TH1F* hSMVH125_mssmHigh_Down = (TH1F*)fin->Get("hSMEffTDownVH125");
      hSMVH125_mssmHigh_Down->SetName("VH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown" );
      hSMVH125_mssmHigh_Down->Write("VH_SM125_CMS_eff_t_mssmHigh_mutau_8TeVDown");

      // CMS_htt_eff_trig_mssmHigh_ltau_8TeV
      TH1F* hSMGGFH125_TriggerBugUp = (TH1F*)fin->Get("hGGFH125_TriggerBugUp");
      hSMGGFH125_TriggerBugUp->SetName("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hSMGGFH125_TriggerBugUp->Write("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hSMGGFH125_TriggerBugDown = (TH1F*)fin->Get("hGGFH125_TriggerBugDown");
      hSMGGFH125_TriggerBugDown->SetName("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hSMGGFH125_TriggerBugDown->Write("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      TH1F* hSMVBFH125_TriggerBugUp = (TH1F*)fin->Get("hVBFH125_TriggerBugUp");
      hSMVBFH125_TriggerBugUp->SetName("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hSMVBFH125_TriggerBugUp->Write("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hSMVBFH125_TriggerBugDown = (TH1F*)fin->Get("hVBFH125_TriggerBugDown");
      hSMVBFH125_TriggerBugDown->SetName("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hSMVBFH125_TriggerBugDown->Write("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      TH1F* hSMVH125_TriggerBugUp = (TH1F*)fin->Get("hVH125_TriggerBugUp");
      hSMVH125_TriggerBugUp->SetName("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hSMVH125_TriggerBugUp->Write("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hSMVH125_TriggerBugDown = (TH1F*)fin->Get("hVH125_TriggerBugDown");
      hSMVH125_TriggerBugDown->SetName("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hSMVH125_TriggerBugDown->Write("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      //SM signal ggH shifted Up/Down by HqT
      TH1F* hSMGGFH125Up = (TH1F*)fin->Get("hGGFH125Up");
      hSMGGFH125Up->SetName("ggH_SM125_CMS_htt_higgsPtReweightSM_8TeVUp" );
      hSMGGFH125Up->Write("ggH_SM125_CMS_htt_higgsPtReweightSM_8TeVUp");

      TH1F* hSMGGFH125Down = (TH1F*)fin->Get("hGGFH125Down");
      hSMGGFH125Down->SetName("ggH_SM125_CMS_htt_higgsPtReweightSM_8TeVDown" );
      hSMGGFH125Down->Write("ggH_SM125_CMS_htt_higgsPtReweightSM_8TeVDown");   

      // ZTT: embedded sample Trigger Bug
      TH1F* hDataEmb_TriggerBugUp = ((TH1F*)fin->Get(nameZtt+"_TriggerBugUp"));
      TH1F* hDataEmb_NotSubtracted_TriggerBugUp = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_TriggerBugUp"));
      TH1F* hTTbarEmb_TriggerBugUp = ((TH1F*)fin->Get("hTTbEmb_TriggerBugUp"));
      if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_TriggerBugUp, hDataEmb_NotSubtracted_TriggerBugUp, hTTbarEmb_TriggerBugUp);
      hDataEmb_TriggerBugUp->SetName("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hDataEmb_TriggerBugUp->Write("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hDataEmb_TriggerBugDown = ((TH1F*)fin->Get(nameZtt+"_TriggerBugDown"));
      TH1F* hDataEmb_NotSubtracted_TriggerBugDown = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_TriggerBugDown"));
      TH1F* hTTbarEmb_TriggerBugDown = ((TH1F*)fin->Get("hTTbEmb_TriggerBugDown"));
      if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_TriggerBugDown, hDataEmb_NotSubtracted_TriggerBugDown, hTTbarEmb_TriggerBugDown);
      hDataEmb_TriggerBugDown->SetName("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hDataEmb_TriggerBugDown->Write("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      if(useEmb)
	{

	  TH1F* hDataEmb_1Prong0Pi0_TriggerBugUp = ((TH1F*)fin->Get(nameZtt+"_1Prong0Pi0_TriggerBugUp"));
	  TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp"));
	  TH1F* hTTbarEmb_1Prong0Pi0_TriggerBugUp = ((TH1F*)fin->Get("hTTbEmb_1Prong0Pi0_TriggerBugUp"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong0Pi0_TriggerBugUp, hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp, hTTbarEmb_1Prong0Pi0_TriggerBugUp);
	  hDataEmb_1Prong0Pi0_TriggerBugUp->SetName("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	  hDataEmb_1Prong0Pi0_TriggerBugUp->Write("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

	  TH1F* hDataEmb_1Prong0Pi0_TriggerBugDown = ((TH1F*)fin->Get(nameZtt+"_1Prong0Pi0_TriggerBugDown"));
	  TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown"));
	  TH1F* hTTbarEmb_1Prong0Pi0_TriggerBugDown = ((TH1F*)fin->Get("hTTbEmb_1Prong0Pi0_TriggerBugDown"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong0Pi0_TriggerBugDown, hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown, hTTbarEmb_1Prong0Pi0_TriggerBugDown);
	  hDataEmb_1Prong0Pi0_TriggerBugDown->SetName("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	  hDataEmb_1Prong0Pi0_TriggerBugDown->Write("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

	  TH1F* hDataEmb_1Prong1Pi0_TriggerBugUp = ((TH1F*)fin->Get(nameZtt+"_1Prong1Pi0_TriggerBugUp"));
	  TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp"));
	  TH1F* hTTbarEmb_1Prong1Pi0_TriggerBugUp = ((TH1F*)fin->Get("hTTbEmb_1Prong1Pi0_TriggerBugUp"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong1Pi0_TriggerBugUp, hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp, hTTbarEmb_1Prong1Pi0_TriggerBugUp);
	  hDataEmb_1Prong1Pi0_TriggerBugUp->SetName("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	  hDataEmb_1Prong1Pi0_TriggerBugUp->Write("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

	  TH1F* hDataEmb_1Prong1Pi0_TriggerBugDown = ((TH1F*)fin->Get(nameZtt+"_1Prong1Pi0_TriggerBugDown"));
	  TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown"));
	  TH1F* hTTbarEmb_1Prong1Pi0_TriggerBugDown = ((TH1F*)fin->Get("hTTbEmb_1Prong1Pi0_TriggerBugDown"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong1Pi0_TriggerBugDown, hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown, hTTbarEmb_1Prong1Pi0_TriggerBugDown);
	  hDataEmb_1Prong1Pi0_TriggerBugDown->SetName("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	  hDataEmb_1Prong1Pi0_TriggerBugDown->Write("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

	  TH1F* hDataEmb_3Prong_TriggerBugUp = ((TH1F*)fin->Get(nameZtt+"_3Prong_TriggerBugUp"));
	  TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugUp = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_3Prong_TriggerBugUp"));
	  TH1F* hTTbarEmb_3Prong_TriggerBugUp = ((TH1F*)fin->Get("hTTbEmb_3Prong_TriggerBugUp"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_3Prong_TriggerBugUp, hDataEmb_NotSubtracted_3Prong_TriggerBugUp, hTTbarEmb_3Prong_TriggerBugUp);
	  hDataEmb_3Prong_TriggerBugUp->SetName("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	  hDataEmb_3Prong_TriggerBugUp->Write("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

	  TH1F* hDataEmb_3Prong_TriggerBugDown = ((TH1F*)fin->Get(nameZtt+"_3Prong_TriggerBugDown"));
	  TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugDown = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_3Prong_TriggerBugDown"));
	  TH1F* hTTbarEmb_3Prong_TriggerBugDown = ((TH1F*)fin->Get("hTTbEmb_3Prong_TriggerBugDown"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_3Prong_TriggerBugDown, hDataEmb_NotSubtracted_3Prong_TriggerBugDown, hTTbarEmb_3Prong_TriggerBugDown);
	  hDataEmb_3Prong_TriggerBugDown->SetName("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	  hDataEmb_3Prong_TriggerBugDown->Write("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	}

      //ZL: Trigger Bug
      TH1F* hZmm_TriggerBugUp = ((TH1F*)fin->Get("hZmm_TriggerBugUp"));
      hZmm_TriggerBugUp->SetName("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hZmm_TriggerBugUp->Write("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hZmm_TriggerBugDown = ((TH1F*)fin->Get("hZmm_TriggerBugDown"));
      hZmm_TriggerBugDown->SetName("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hZmm_TriggerBugDown->Write("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      //ZJ: Trigger Bug
      TH1F* hZmj_TriggerBugUp = ((TH1F*)fin->Get("hZmj_TriggerBugUp"));
      hZmj_TriggerBugUp->SetName("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hZmj_TriggerBugUp->Write("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hZmj_TriggerBugDown = ((TH1F*)fin->Get("hZmj_TriggerBugDown"));
      hZmj_TriggerBugDown->SetName("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hZmj_TriggerBugDown->Write("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      //W: Trigger Bug
      TH1F* hW_TriggerBugUp = ((TH1F*)fin->Get("hW_TriggerBugUp"));
      hW_TriggerBugUp->SetName("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hW_TriggerBugUp->Write("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hW_TriggerBugDown = ((TH1F*)fin->Get("hW_TriggerBugDown"));
      hW_TriggerBugDown->SetName("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hW_TriggerBugDown->Write("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      //TTb: Trigger Bug
      TH1F* hTTb_TriggerBugUp = ((TH1F*)fin->Get("hTTb_TriggerBugUp"));
      hTTb_TriggerBugUp->SetName("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hTTb_TriggerBugUp->Write("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hTTb_TriggerBugDown = ((TH1F*)fin->Get("hTTb_TriggerBugDown"));
      hTTb_TriggerBugDown->SetName("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hTTb_TriggerBugDown->Write("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");

      //VV: Trigger Bug
      TH1F* hVV_TriggerBugUp = ((TH1F*)fin->Get("hVV_TriggerBugUp"));
      hVV_TriggerBugUp->SetName("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      hVV_TriggerBugUp->Write("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");

      TH1F* hVV_TriggerBugDown = ((TH1F*)fin->Get("hVV_TriggerBugDown"));
      hVV_TriggerBugDown->SetName("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      hVV_TriggerBugDown->Write("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
    }
	...
	*/
	...
	hZmm_Up->SetName(Form("ZL%s"        ,"_CMS_htt_ZLScale_mutau_8TeVUp"));
      ...
      // ZTT: embedded sample
      TH1F* hDataEmb = ((TH1F*)fin->Get(nameZtt));
      //remove zero bins + setting right error
      TH1F* hDataEmb_NotSubtracted = ((TH1F*)fin->Get("hDataEmb_NotSubtracted"));
      TH1F* hTTbarEmb = ((TH1F*)fin->Get("hTTbEmb"));
      if(useEmb) TreatNegativeBinsDataEmb(hDataEmb, hDataEmb_NotSubtracted, hTTbarEmb);
      hDataEmb->SetName(Form("ZTT%s",suffix.c_str()));
      hDataEmb->Write(Form("ZTT%s",suffix.c_str()));
      ...
      //remove zero bins + setting right error
      TH1F* hDataEmb_NotSubtracted_fb = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_fb"));
      TH1F* hTTbarEmb_fb = ((TH1F*)fin->Get("hTTbEmb_fb"));
      if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_fb, hDataEmb_NotSubtracted_fb, hTTbarEmb_fb);
      ...
      if(useEmb)
	{
	  ...
	  TH1F* hDataEmb_1Prong0Pi0 = ((TH1F*)fin->Get(nameZtt+"_1Prong0Pi0"));
	  TH1F* hDataEmb_NotSubtracted_1Prong0Pi0 = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong0Pi0"));
	  TH1F* hTTbarEmb_1Prong0Pi0 = ((TH1F*)fin->Get("hTTbEmb_1Prong0Pi0"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong0Pi0, hDataEmb_NotSubtracted_1Prong0Pi0, hTTbarEmb_1Prong0Pi0);
	  ...
	  TH1F* hDataEmb_1Prong1Pi0 = ((TH1F*)fin->Get(nameZtt+"_1Prong1Pi0"));
	  TH1F* hDataEmb_NotSubtracted_1Prong1Pi0 = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong1Pi0"));
	  TH1F* hTTbarEmb_1Prong1Pi0 = ((TH1F*)fin->Get("hTTbEmb_1Prong1Pi0"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong1Pi0, hDataEmb_NotSubtracted_1Prong1Pi0, hTTbarEmb_1Prong1Pi0);
	  ...
	  TH1F* hDataEmb_3Prong = ((TH1F*)fin->Get(nameZtt+"_3Prong"));
	  TH1F* hDataEmb_NotSubtracted_3Prong = ((TH1F*)fin->Get("hDataEmb_NotSubtracted_3Prong"));
	  TH1F* hTTbarEmb_3Prong = ((TH1F*)fin->Get("hTTbEmb_3Prong"));
	  if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_3Prong, hDataEmb_NotSubtracted_3Prong, hTTbarEmb_3Prong);
	...
	// 	QCDCorrUpName = QCDCorrUpName+"_"+binNameSpace;
	...
	// 	QCDCorrDownName = QCDCorrDownName+"_"+binNameSpace;
	hQCD_CorrDown->SetName(QCDCorrDownName+"_8TeVDown");
	checkValidity(hQCD_CorrDown);
	hQCD_CorrDown->Write();

	TH1F *hQCD_fb_CorrUp = (TH1F*)fin->Get("hQCD_CorrUp_fb");
	TString QCDCorrUpName_fb = "QCD_CMS_htt_QCDfrShape_mutau" ;
	// 	QCDCorrUpName_fb = QCDCorrUpName_fb+"_"+binNameSpace;
	hQCD_fb_CorrUp->SetName(QCDCorrUpName_fb+"_8TeVUp_fine_binning");
	checkValidity(hQCD_fb_CorrUp);
	hQCD_fb_CorrUp->Write();

	TH1F *hQCD_fb_CorrDown = (TH1F*)fin->Get("hQCD_CorrDown_fb");
	TString QCDCorrDownName_fb = "QCD_CMS_htt_QCDfrShape_mutau" ;
	// 	QCDCorrDownName_fb = QCDCorrDownName_fb+"_"+binNameSpace;
	hQCD_fb_CorrDown->SetName(QCDCorrDownName_fb+"_8TeVDown_fine_binning");
	checkValidity(hQCD_fb_CorrDown);
	hQCD_fb_CorrDown->Write();
	...
	if(suffix == ""){
	  ...
	  if(bin_.find("nobTagHigh")!=string::npos && !bin_.find("HighMt")!=string::npos)
	    {
	      //cout<<"filling W-shape"<<endl;
	      //cout<<"WShape = "<<WShape<<endl;

	      // 	      cout<<"bin = "<<bin_<<endl;
	      // 	      cout<<"binNameSpace = "<<binNameSpace<<endl;
	      // 	      cout<<"fin->GetName() = "<<fin->GetName()<<endl;

	      TH1F* hW_TFUp = ((TH1F*)fin->Get("hW_TFUp"));
	      if(Displays) cout<<"hW_TFUp = "<<hW_TFUp->Integral()<<endl;
    ...
    if(Displays) cout << "Directory is there, filling new histos..." << endl;
	...
	hSgn1_PtDown->Write(Form("ggH%d_CMS_htt_higgsPtReweight_8TeVDown",mH_));
      ...
      if(dir->FindObjectAny(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVUp",mH_))==0){//when POWHEG is filled
	//  	TH1F* hSgn1_PtScaleUp = (TH1F*)fin->Get(Form("hSUSYGGH%d",mH_));
	TH1F* hSgn1_PtScaleUp = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleUp",mH_));
	hSgn1_PtScaleUp->SetName(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVUp",mH_));
	hSgn1_PtScaleUp->Write(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVUp",mH_));
      }
      if(dir->FindObjectAny(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVDown",mH_))==0){//when POWHEG is filled
	//  	TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%d",mH_));
	TH1F* hSgn1_PtScaleDown = (TH1F*)fin->Get(Form("hSUSYGGH%dScaleDown",mH_));
	hSgn1_PtScaleDown->SetName(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVDown",mH_));
	hSgn1_PtScaleDown->Write(Form("ggH%d_CMS_htt_higgsPtReweight_scale_8TeVDown",mH_));
      }
      if(dir->FindObjectAny(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_))==0){
 	TH1F* hSgn1_TriggerBugUp = (TH1F*)fin->Get(Form("hSUSYGGH%d_TriggerBugUp",mH_));
	hSgn1_TriggerBugUp->SetName(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
	hSgn1_TriggerBugUp->Write(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
      }
      if(dir->FindObjectAny(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_))==0){
 	TH1F* hSgn1_TriggerBugDown = (TH1F*)fin->Get(Form("hSUSYGGH%d_TriggerBugDown",mH_));
	hSgn1_TriggerBugDown->SetName(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
	hSgn1_TriggerBugDown->Write(Form("ggH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      }
	...
	hSgn2_Down->Write(Form("bbH%d_CMS_eff_t_mssmHigh_mutau_8TeVDown",mH_));
      ...
      if(dir->FindObjectAny(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_))==0){
 	TH1F* hSgn2_TriggerBugUp = (TH1F*)fin->Get(Form("hSUSYBBH%d_TriggerBugUp",mH_));
	hSgn2_TriggerBugUp->SetName(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
	hSgn2_TriggerBugUp->Write(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp",mH_));
      }
      if(dir->FindObjectAny(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_))==0){
 	TH1F* hSgn2_TriggerBugDown = (TH1F*)fin->Get(Form("hSUSYBBH%d_TriggerBugDown",mH_));
	hSgn2_TriggerBugDown->SetName(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
	hSgn2_TriggerBugDown->Write(Form("bbH%d_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown",mH_));
      }
      ...
      if(dir->FindObjectAny(Form("ggH_SM125%s",suffix.c_str()))==0 ){
        TH1F* hSMGGFH125_UpDown = (TH1F*)fin->Get("hGGFH125");
	hSMGGFH125_UpDown->SetName(Form("ggH_SM125%s", suffix.c_str()));
        hSMGGFH125_UpDown->Write(Form("ggH_SM125%s" , suffix.c_str()));
      }
      if(dir->FindObjectAny(Form("qqH_SM125%s",suffix.c_str()))==0 ){
        TH1F* hSMVBFH125_UpDown = (TH1F*)fin->Get("hVBFH125");
	hSMVBFH125_UpDown->SetName(Form("qqH_SM125%s", suffix.c_str()));
        hSMVBFH125_UpDown->Write(Form("qqH_SM125%s" , suffix.c_str()));
      }
      if(dir->FindObjectAny(Form("VH_SM125%s",suffix.c_str()))==0 ){
        TH1F* hSMVH125_UpDown = (TH1F*)fin->Get("hVH125");
	hSMVH125_UpDown->SetName(Form("VH_SM125%s", suffix.c_str()));
        hSMVH125_UpDown->Write(Form("VH_SM125%s" , suffix.c_str()));
      }
      if(dir->FindObjectAny("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hSMGGFH125_TriggerBugUp = (TH1F*)fin->Get("hGGFH125_TriggerBugUp");
	hSMGGFH125_TriggerBugUp->SetName("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hSMGGFH125_TriggerBugUp->Write("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hSMGGFH125_TriggerBugDown = (TH1F*)fin->Get("hGGFH125_TriggerBugDown");
	hSMGGFH125_TriggerBugDown->SetName("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hSMGGFH125_TriggerBugDown->Write("ggH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hSMVBFH125_TriggerBugUp = (TH1F*)fin->Get("hVBFH125_TriggerBugUp");
	hSMVBFH125_TriggerBugUp->SetName("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hSMVBFH125_TriggerBugUp->Write("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hSMVBFH125_TriggerBugDown = (TH1F*)fin->Get("hVBFH125_TriggerBugDown");
	hSMVBFH125_TriggerBugDown->SetName("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hSMVBFH125_TriggerBugDown->Write("qqH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hSMVH125_TriggerBugUp = (TH1F*)fin->Get("hVH125_TriggerBugUp");
	hSMVH125_TriggerBugUp->SetName("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hSMVH125_TriggerBugUp->Write("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hSMVH125_TriggerBugDown = (TH1F*)fin->Get("hVH125_TriggerBugDown");
	hSMVH125_TriggerBugDown->SetName("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hSMVH125_TriggerBugDown->Write("VH_SM125_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hDataEmb_TriggerBugUp = (TH1F*)fin->Get(nameZtt+"_TriggerBugUp");
	TH1F* hDataEmb_NotSubtracted_TriggerBugUp = (TH1F*)fin->Get("hDataEmb_NotSubtracted_TriggerBugUp");
	TH1F* hTTbarEmb_TriggerBugUp = (TH1F*)fin->Get("hTTbEmb_TriggerBugUp");
	if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_TriggerBugUp, hDataEmb_NotSubtracted_TriggerBugUp, hTTbarEmb_TriggerBugUp);
	...
	hDataEmb_TriggerBugUp->Write("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      ...
      if(dir->FindObjectAny("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hDataEmb_TriggerBugDown = (TH1F*)fin->Get(nameZtt+"_TriggerBugDown");
	TH1F* hDataEmb_NotSubtracted_TriggerBugDown = (TH1F*)fin->Get("hDataEmb_NotSubtracted_TriggerBugDown");
	TH1F* hTTbarEmb_TriggerBugDown = (TH1F*)fin->Get("hTTbEmb_TriggerBugDown");
	if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_TriggerBugDown, hDataEmb_NotSubtracted_TriggerBugDown, hTTbarEmb_TriggerBugDown);
	...
	hDataEmb_TriggerBugDown->Write("ZTT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      ...
      if(useEmb)
	{
	  if(dir->FindObjectAny("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
	    TH1F* hDataEmb_1Prong0Pi0_TriggerBugUp = (TH1F*)fin->Get(nameZtt+"_1Prong0Pi0_TriggerBugUp");
	    TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp = (TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp");
	    TH1F* hTTbarEmb_1Prong0Pi0_TriggerBugUp = (TH1F*)fin->Get("hTTbEmb_1Prong0Pi0_TriggerBugUp");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong0Pi0_TriggerBugUp, hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugUp, hTTbarEmb_1Prong0Pi0_TriggerBugUp);
	  ...
	  if(dir->FindObjectAny("ZTT_1Prong0Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
	    TH1F* hDataEmb_1Prong0Pi0_TriggerBugDown = (TH1F*)fin->Get(nameZtt+"_1Prong0Pi0_TriggerBugDown");
	    TH1F* hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown = (TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown");
	    TH1F* hTTbarEmb_1Prong0Pi0_TriggerBugDown = (TH1F*)fin->Get("hTTbEmb_1Prong0Pi0_TriggerBugDown");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong0Pi0_TriggerBugDown, hDataEmb_NotSubtracted_1Prong0Pi0_TriggerBugDown, hTTbarEmb_1Prong0Pi0_TriggerBugDown);
	  ...
	  if(dir->FindObjectAny("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
	    TH1F* hDataEmb_1Prong1Pi0_TriggerBugUp = (TH1F*)fin->Get(nameZtt+"_1Prong1Pi0_TriggerBugUp");
	    TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp = (TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp");
	    TH1F* hTTbarEmb_1Prong1Pi0_TriggerBugUp = (TH1F*)fin->Get("hTTbEmb_1Prong1Pi0_TriggerBugUp");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong1Pi0_TriggerBugUp, hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugUp, hTTbarEmb_1Prong1Pi0_TriggerBugUp);
	  ...
	  if(dir->FindObjectAny("ZTT_1Prong1Pi0_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
	    TH1F* hDataEmb_1Prong1Pi0_TriggerBugDown = (TH1F*)fin->Get(nameZtt+"_1Prong1Pi0_TriggerBugDown");
	    TH1F* hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown = (TH1F*)fin->Get("hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown");
	    TH1F* hTTbarEmb_1Prong1Pi0_TriggerBugDown = (TH1F*)fin->Get("hTTbEmb_1Prong1Pi0_TriggerBugDown");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_1Prong1Pi0_TriggerBugDown, hDataEmb_NotSubtracted_1Prong1Pi0_TriggerBugDown, hTTbarEmb_1Prong1Pi0_TriggerBugDown);
	  ...
	  if(dir->FindObjectAny("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
	    TH1F* hDataEmb_3Prong_TriggerBugUp = (TH1F*)fin->Get(nameZtt+"_3Prong_TriggerBugUp");
	    TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugUp = (TH1F*)fin->Get("hDataEmb_NotSubtracted_3Prong_TriggerBugUp");
	    TH1F* hTTbarEmb_3Prong_TriggerBugUp = (TH1F*)fin->Get("hTTbEmb_3Prong_TriggerBugUp");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_3Prong_TriggerBugUp, hDataEmb_NotSubtracted_3Prong_TriggerBugUp, hTTbarEmb_3Prong_TriggerBugUp);
	  ...
	  if(dir->FindObjectAny("ZTT_3Prong_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
	    TH1F* hDataEmb_3Prong_TriggerBugDown = (TH1F*)fin->Get(nameZtt+"_3Prong_TriggerBugDown");
	    TH1F* hDataEmb_NotSubtracted_3Prong_TriggerBugDown = (TH1F*)fin->Get("hDataEmb_NotSubtracted_3Prong_TriggerBugDown");
	    TH1F* hTTbarEmb_3Prong_TriggerBugDown = (TH1F*)fin->Get("hTTbEmb_3Prong_TriggerBugDown");
	    if(useEmb) TreatNegativeBinsDataEmb(hDataEmb_3Prong_TriggerBugDown, hDataEmb_NotSubtracted_3Prong_TriggerBugDown, hTTbarEmb_3Prong_TriggerBugDown);
      ...
      if(dir->FindObjectAny("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hZmm_TriggerBugUp = (TH1F*)fin->Get("hZmm_TriggerBugUp");
	hZmm_TriggerBugUp->SetName("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hZmm_TriggerBugUp->Write("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hZmm_TriggerBugDown = (TH1F*)fin->Get("hZmm_TriggerBugDown");
	hZmm_TriggerBugDown->SetName("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hZmm_TriggerBugDown->Write("ZL_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hZmj_TriggerBugUp = (TH1F*)fin->Get("hZmj_TriggerBugUp");
	hZmj_TriggerBugUp->SetName("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hZmj_TriggerBugUp->Write("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hZmj_TriggerBugDown = (TH1F*)fin->Get("hZmj_TriggerBugDown");
	hZmj_TriggerBugDown->SetName("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hZmj_TriggerBugDown->Write("ZJ_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hW_TriggerBugUp = (TH1F*)fin->Get("hW_TriggerBugUp");
	hW_TriggerBugUp->SetName("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hW_TriggerBugUp->Write("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hW_TriggerBugDown = (TH1F*)fin->Get("hW_TriggerBugDown");
	hW_TriggerBugDown->SetName("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hW_TriggerBugDown->Write("W_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hTTb_TriggerBugUp = (TH1F*)fin->Get("hTTb_TriggerBugUp");
	hTTb_TriggerBugUp->SetName("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hTTb_TriggerBugUp->Write("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hTTb_TriggerBugDown = (TH1F*)fin->Get("hTTb_TriggerBugDown");
	hTTb_TriggerBugDown->SetName("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hTTb_TriggerBugDown->Write("TT_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
      if(dir->FindObjectAny("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp")==0){
 	TH1F* hVV_TriggerBugUp = (TH1F*)fin->Get("hVV_TriggerBugUp");
	hVV_TriggerBugUp->SetName("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
	hVV_TriggerBugUp->Write("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVUp");
      }
      if(dir->FindObjectAny("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown")==0){
 	TH1F* hVV_TriggerBugDown = (TH1F*)fin->Get("hVV_TriggerBugDown");
	hVV_TriggerBugDown->SetName("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
	hVV_TriggerBugDown->Write("VV_CMS_htt_eff_trig_mssmHigh_ltau_8TeVDown");
      }
...
void produceOne(  TString outputDir = "Results_ABCD_AntiMu1_AntiEle1_TauIso1_Datacards",bool DOSUSY = false,TString boostLabel = "", string variable = ""){
  ...
  //   variables.push_back("diTauNSVfitMass");//here was uncommented
  ...
  for(unsigned int i = 0 ; i < variables.size(); i++){
	...
	*/
	...
	//For control plots
	  ...
	  {
	    if(variables[i]!="MtLeg1MVA" && variables[i]!="visibleTauMass" && variables[i]!="decayMode")
	      {
		...
		produce(mH[j],variables[i], "" , "bTagLow", outputDir,true);
		produce(mH[j],variables[i], "" , "nobTagLow", outputDir,true);
	      }
	    else if(variables[i]=="visibleTauMass" || variables[i]=="decayMode")
	      {
		produce(mH[j],variables[i], "" , "inclusive", outputDir,true);
		produce(mH[j],variables[i], "TauUp" , "inclusive", outputDir,true);
		produce(mH[j],variables[i], "TauDown" , "inclusive", outputDir,true);
		...
		produce(mH[j],variables[i], "JetDown" , "inclusive", outputDir,true);
	      ...
	      {
		produce(mH[j],variables[i], "" , "inclusiveNoMt", outputDir,true);
		// 	    produce(mH[j],variables[i], "" , "bTag", outputDir,true);
		// 	    produce(mH[j],variables[i], "" , "nobTag", outputDir,true);
		produce(mH[j],variables[i], "" , "bTagHighNoMt", outputDir,true);
		produce(mH[j],variables[i], "" , "nobTagHighNoMt", outputDir,true);
		produce(mH[j],variables[i], "" , "nobTagMediumNoMt", outputDir,true);
		produce(mH[j],variables[i], "" , "bTagLowNoMt", outputDir,true);
		produce(mH[j],variables[i], "" , "nobTagLowNoMt", outputDir,true);
	      }
	  }
...
void produceAll(){ 
  ...
  TString simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_ptL_hi_060215/";
//   TString simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_ptL_md_060215/";
//   TString simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_CombinationGroup_060215/";
//   TString simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_TestTriggerBug_081214/";
  //   TString simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_261114/";
...
//   variables.push_back("diTauVisMass");
  ...
  for(UInt_t i = 0 ; i < variables.size() ; ++i)
	...
	{// 
	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_tauPolarOn_110215";
	  TString OutFileName = "";
	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_tauPolarOn_110215/datacards/") ;
	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_tauPolarOn_110215/datacards/") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_060215";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_060215/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_ZttMC_060215/datacards/") ;

// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_CombinationGroup_060215/datacards/") ;
// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_040215";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_040215/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Shalhout_040215/datacards/") ;
// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_NoTriggerEmb_230115/datacards/") ;
// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_210115/datacards/") ;
// 	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115";
// 	  TString OutFileName = "";
// 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115/datacards/") ;
// 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_ZttMC_160115/datacards/") ;
	  // 	  TString OutFileName = "";
	  // 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_281214/datacards/") ;
	  // 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_Sync_281214/datacards/") ;
	  // 	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_TestTriggerBug_081214/datacards/muTau*_PtWeight.root") ;
	  // 	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_Datacards_TestTriggerBug_081214/datacards/muTau*_NoPtWeight.root") ;
	  TString Command = "rm "+OutFileName+"muTauMSSM_"+variables.at(i)+"_newNames4_PtWeight.root";
      ...
      else if(variables.at(i)=="visibleTauMass" || variables.at(i)=="decayMode" || variables.at(i)=="diTauVisMass")
	{                                
	  TString local_simple_folder = "Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_TestTriggerBug_081214";
	  TString OutFileName = "";
	  if(HiggsPtReweighting) OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_TestTriggerBug_081214/datacards/") ;
	  else OutFileName = Form("results/MuTau/Results_ABCD_AntiMuMVAMedium_AntiEleLoose_HPSMVA3oldDMwLTTight_TauOldDM_OldEleID_SVfitMassCut_ControlPlots_TestTriggerBug_081214/datacards/") ;
	  TString Command = "rm "+OutFileName+"muTauMSSM_"+variables.at(i)+"_newNames4_PtWeight.root";
	  gSystem->Exec(Command.Data());
      ...
      else
	{
	  ...
	  TString Command = "rm "+OutFileName+"muTauMSSM_"+variables.at(i)+"_newNames4_PtWeight.root";
	  gSystem->Exec(Command.Data());	  
	  produceOne(simple_folder,true,"",variables.at(i));
	}
    }
