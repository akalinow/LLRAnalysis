...
int fId1 = 0; int fId2 = 0; float fGPhi1 = 0; float fGPhi2 = 0; float fGEta1 = 0; float fGEta2 = 0; float fEta2 = 0; float fPhi2 = 0;
void load(TTree *iTree, int type) { 
  ...
  iTree->SetBranchAddress("pt_z" ,&fZPt);
  iTree->SetBranchAddress("phi_z",&fZPhi);
...
void fitGraph(TTree *iTree, TCanvas *iC,
  ...
  std::string lType = "pol3"; if(iPol1) lType = "pol1"; 
  ...
  if(iRMS) {    
    ...
    for(unsigned int i0 = 0; i0 < lXVals.size(); i0++) { 
      ...
      lResidVals[pId].add(RooArgSet(lRXVar)); //Fill the Double Gaussian
...
void runRecoilFit_v3() { 
  Prep();
  //fDataFile = new TFile("ntuples_ee/zee_select_42.root");
  //fDataTree = (TTree*) fDataFile->FindObjectAny("Events");
  //fNJetSelect = 0; fMetMax = 4000; fZPtMax = 90;   fitRecoil(fDataTree,"recoilfits/recoilfit_zee42X_0jet.root");
  //fNJetSelect = 1; fMetMax = 4000; fZPtMax = 500;  fitRecoil(fDataTree,"recoilfits/recoilfit_zee42X_1jet.root");
  //fNJetSelect = 2; fMetMax = 4000; fZPtMax = 500;  fitRecoil(fDataTree,"recoilfits/recoilfit_zee42X_2jet.root");
  //delete fDataFile;

  //fDataFile = new TFile("ntuples/data_select.root");
  //fDataTree = (TTree*) fDataFile->FindObjectAny("Events");
  //fNJetSelect = 0; fMetMax = 4000; fZPtMax = 500; fitRecoil(fDataTree,"recoilfits/recoilfit_datamm_0jet.root");
