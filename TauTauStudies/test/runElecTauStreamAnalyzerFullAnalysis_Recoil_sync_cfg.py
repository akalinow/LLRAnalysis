...
process.metRecoilCorrector = cms.EDProducer(
    ...
    muonTag             = cms.InputTag(""),
    tauTag              = cms.InputTag("tauPtEtaIDAgMuAgElecIso"),
    inputFileNamezmm42X = cms.FileInPath("LLRAnalysis/Utilities/data/recoilv5/RecoilCorrector_v5/recoilfits/recoilfit_zmm53X_20pv_njet.root"),
    inputFileNamedatamm = cms.FileInPath("LLRAnalysis/Utilities/data/recoilv5/RecoilCorrector_v5/recoilfits/recoilfit_datamm53X_20pv_njet.root"),
    inputFileNamewjets  = cms.FileInPath("LLRAnalysis/Utilities/data/recoilv5/RecoilCorrector_v5/recoilfits/recoilfit_wjets53X_20pv_njet.root"),
    inputFileNamezjets  = cms.FileInPath("LLRAnalysis/Utilities/data/recoilv5/RecoilCorrector_v5/recoilfits/recoilfit_zmm53X_20pv_njet.root"),
    inputFileNamehiggs  = cms.FileInPath("LLRAnalysis/Utilities/data/recoilv5/RecoilCorrector_v5/recoilfits/recoilfit_higgs53X_20pv_njet.root"),
    numOfSigmas         = cms.double(1.0),
