...
double ratioEfficiency::efficiency(double m, double m0, double sigma, double alpha, double n, double norm) const 
 { 
...
double ratioEfficiency::ratio(double pt, bool EB) const
{
  double ratio = 0 ;
...
double ratioEfficiency::dataEfficiency(double pt, bool EB) const
{
  double ratio = 0 ;
  if (pt<15) return ratio ;
