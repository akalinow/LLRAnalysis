...
class RecoilCorrector
{
 ...
 public:
  RecoilCorrector(string iNameZDat = "/data_CMS/cms/lbianchini/VbfJetsStudy/Utilities//recoilfitZDat.root",string iNameZMC  = "/data_CMS/cms/lbianchini/VbfJetsStudy/Utilities/recoilfitZMC.root", int iSeed=0xDEADBEEF);
 ...
 protected:
  int readRecoil(std::vector<double> &iSumEt,
		       ...
		       std::string iFName = "/data_CMS/cms/lbianchini/VbfJetsStudy/Utilities/recoilfit-new.root"); 
