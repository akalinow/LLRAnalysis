...
process.source = cms.Source("PoolSource",
    ...
    #'file:./pickevents_DataRun2012D_AOD.root'
    'file:~/TestTrees/002F5062-346F-E211-BF00-1CC1DE04DF20.root'
    #'file:/data_CMS/cms/ivo/HTauTauAnalysis/AOD/DataRun2012D_ReReco22Jan/02CFA40C-9E8C-E211-B65B-002481E94B6C.root'
...
##     firstRun = cms.untracked.uint32(205908),
##     #firstEvent = cms.untracked.uint32(153049305),
##     firstEvent = cms.untracked.uint32(153589242),
...
process.patElectronMatchedCaloJet = process.patTauMatchedCaloJet.clone()
process.patElectronMatchedCaloJet.candidateTag = 'electronsForVeto'
process.makeRecoTauMatchedCaloJets += process.patElectronMatchedCaloJet
...
process.out.outputCommands.extend( cms.vstring(
    ...
    'keep *_patElectronMatchedCaloJet_*_*',
    #To re-make patJets
