...
process.tauPtEtaIDAgMuLAgElec = cms.EDFilter( #apply AntiLep cuts
    ...
    #src = cms.InputTag("tauPtEtaIDAgMuLAgElec"),#changed preselection --> now applied to T-ES corrected taus (see line above)
...
#Check with Ivo/Christian that this can be safely removed!!!
#if useLepTauPAT:
...
process.seqNominal = cms.Sequence(
    ...
    process.runPatJets*
    process.applyTauES*
    (process.tauPtEtaIDAgMuLAgElec*process.tauPtEtaIDAgMuAgElec*
...
process.seqTauUp = cms.Sequence(
    ...
    process.elecPtEtaID* #MB
    (process.elecPtEtaIDIso*process.elecPtEtaIDIsoCounter) *
    process.tauPtEtaIDAgMuLAgElec*process.tauPtEtaIDAgMuAgElec*process.tauPtEtaIDAgMuAgElecIsoPtRel*
